(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))r(l);new MutationObserver(l=>{for(const c of l)if(c.type==="childList")for(const h of c.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&r(h)}).observe(document,{childList:!0,subtree:!0});function i(l){const c={};return l.integrity&&(c.integrity=l.integrity),l.referrerPolicy&&(c.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?c.credentials="include":l.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function r(l){if(l.ep)return;l.ep=!0;const c=i(l);fetch(l.href,c)}})();var qf={exports:{}},Eo={};var $g;function KS(){if($g)return Eo;$g=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,l,c){var h=null;if(c!==void 0&&(h=""+c),l.key!==void 0&&(h=""+l.key),"key"in l){c={};for(var d in l)d!=="key"&&(c[d]=l[d])}else c=l;return l=c.ref,{$$typeof:o,type:r,key:h,ref:l!==void 0?l:null,props:c}}return Eo.Fragment=e,Eo.jsx=i,Eo.jsxs=i,Eo}var t_;function QS(){return t_||(t_=1,qf.exports=KS()),qf.exports}var nn=QS(),Wf={exports:{}},te={};var e_;function JS(){if(e_)return te;e_=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),v=Symbol.for("react.activity"),x=Symbol.iterator;function y(U){return U===null||typeof U!="object"?null:(U=x&&U[x]||U["@@iterator"],typeof U=="function"?U:null)}var A={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},R=Object.assign,M={};function S(U,nt,St){this.props=U,this.context=nt,this.refs=M,this.updater=St||A}S.prototype.isReactComponent={},S.prototype.setState=function(U,nt){if(typeof U!="object"&&typeof U!="function"&&U!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,U,nt,"setState")},S.prototype.forceUpdate=function(U){this.updater.enqueueForceUpdate(this,U,"forceUpdate")};function z(){}z.prototype=S.prototype;function D(U,nt,St){this.props=U,this.context=nt,this.refs=M,this.updater=St||A}var P=D.prototype=new z;P.constructor=D,R(P,S.prototype),P.isPureReactComponent=!0;var et=Array.isArray;function F(){}var L={H:null,A:null,T:null,S:null},j=Object.prototype.hasOwnProperty;function w(U,nt,St){var W=St.ref;return{$$typeof:o,type:U,key:nt,ref:W!==void 0?W:null,props:St}}function C(U,nt){return w(U.type,nt,U.props)}function G(U){return typeof U=="object"&&U!==null&&U.$$typeof===o}function lt(U){var nt={"=":"=0",":":"=2"};return"$"+U.replace(/[=:]/g,function(St){return nt[St]})}var at=/\/+/g;function ct(U,nt){return typeof U=="object"&&U!==null&&U.key!=null?lt(""+U.key):nt.toString(36)}function ht(U){switch(U.status){case"fulfilled":return U.value;case"rejected":throw U.reason;default:switch(typeof U.status=="string"?U.then(F,F):(U.status="pending",U.then(function(nt){U.status==="pending"&&(U.status="fulfilled",U.value=nt)},function(nt){U.status==="pending"&&(U.status="rejected",U.reason=nt)})),U.status){case"fulfilled":return U.value;case"rejected":throw U.reason}}throw U}function O(U,nt,St,W,ot){var xt=typeof U;(xt==="undefined"||xt==="boolean")&&(U=null);var yt=!1;if(U===null)yt=!0;else switch(xt){case"bigint":case"string":case"number":yt=!0;break;case"object":switch(U.$$typeof){case o:case e:yt=!0;break;case _:return yt=U._init,O(yt(U._payload),nt,St,W,ot)}}if(yt)return ot=ot(U),yt=W===""?"."+ct(U,0):W,et(ot)?(St="",yt!=null&&(St=yt.replace(at,"$&/")+"/"),O(ot,nt,St,"",function(ee){return ee})):ot!=null&&(G(ot)&&(ot=C(ot,St+(ot.key==null||U&&U.key===ot.key?"":(""+ot.key).replace(at,"$&/")+"/")+yt)),nt.push(ot)),1;yt=0;var Ft=W===""?".":W+":";if(et(U))for(var It=0;It<U.length;It++)W=U[It],xt=Ft+ct(W,It),yt+=O(W,nt,St,xt,ot);else if(It=y(U),typeof It=="function")for(U=It.call(U),It=0;!(W=U.next()).done;)W=W.value,xt=Ft+ct(W,It++),yt+=O(W,nt,St,xt,ot);else if(xt==="object"){if(typeof U.then=="function")return O(ht(U),nt,St,W,ot);throw nt=String(U),Error("Objects are not valid as a React child (found: "+(nt==="[object Object]"?"object with keys {"+Object.keys(U).join(", ")+"}":nt)+"). If you meant to render a collection of children, use an array instead.")}return yt}function q(U,nt,St){if(U==null)return U;var W=[],ot=0;return O(U,W,"","",function(xt){return nt.call(St,xt,ot++)}),W}function Z(U){if(U._status===-1){var nt=U._result;nt=nt(),nt.then(function(St){(U._status===0||U._status===-1)&&(U._status=1,U._result=St)},function(St){(U._status===0||U._status===-1)&&(U._status=2,U._result=St)}),U._status===-1&&(U._status=0,U._result=nt)}if(U._status===1)return U._result.default;throw U._result}var Mt=typeof reportError=="function"?reportError:function(U){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var nt=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof U=="object"&&U!==null&&typeof U.message=="string"?String(U.message):String(U),error:U});if(!window.dispatchEvent(nt))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",U);return}console.error(U)},Et={map:q,forEach:function(U,nt,St){q(U,function(){nt.apply(this,arguments)},St)},count:function(U){var nt=0;return q(U,function(){nt++}),nt},toArray:function(U){return q(U,function(nt){return nt})||[]},only:function(U){if(!G(U))throw Error("React.Children.only expected to receive a single React element child.");return U}};return te.Activity=v,te.Children=Et,te.Component=S,te.Fragment=i,te.Profiler=l,te.PureComponent=D,te.StrictMode=r,te.Suspense=m,te.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=L,te.__COMPILER_RUNTIME={__proto__:null,c:function(U){return L.H.useMemoCache(U)}},te.cache=function(U){return function(){return U.apply(null,arguments)}},te.cacheSignal=function(){return null},te.cloneElement=function(U,nt,St){if(U==null)throw Error("The argument must be a React element, but you passed "+U+".");var W=R({},U.props),ot=U.key;if(nt!=null)for(xt in nt.key!==void 0&&(ot=""+nt.key),nt)!j.call(nt,xt)||xt==="key"||xt==="__self"||xt==="__source"||xt==="ref"&&nt.ref===void 0||(W[xt]=nt[xt]);var xt=arguments.length-2;if(xt===1)W.children=St;else if(1<xt){for(var yt=Array(xt),Ft=0;Ft<xt;Ft++)yt[Ft]=arguments[Ft+2];W.children=yt}return w(U.type,ot,W)},te.createContext=function(U){return U={$$typeof:h,_currentValue:U,_currentValue2:U,_threadCount:0,Provider:null,Consumer:null},U.Provider=U,U.Consumer={$$typeof:c,_context:U},U},te.createElement=function(U,nt,St){var W,ot={},xt=null;if(nt!=null)for(W in nt.key!==void 0&&(xt=""+nt.key),nt)j.call(nt,W)&&W!=="key"&&W!=="__self"&&W!=="__source"&&(ot[W]=nt[W]);var yt=arguments.length-2;if(yt===1)ot.children=St;else if(1<yt){for(var Ft=Array(yt),It=0;It<yt;It++)Ft[It]=arguments[It+2];ot.children=Ft}if(U&&U.defaultProps)for(W in yt=U.defaultProps,yt)ot[W]===void 0&&(ot[W]=yt[W]);return w(U,xt,ot)},te.createRef=function(){return{current:null}},te.forwardRef=function(U){return{$$typeof:d,render:U}},te.isValidElement=G,te.lazy=function(U){return{$$typeof:_,_payload:{_status:-1,_result:U},_init:Z}},te.memo=function(U,nt){return{$$typeof:p,type:U,compare:nt===void 0?null:nt}},te.startTransition=function(U){var nt=L.T,St={};L.T=St;try{var W=U(),ot=L.S;ot!==null&&ot(St,W),typeof W=="object"&&W!==null&&typeof W.then=="function"&&W.then(F,Mt)}catch(xt){Mt(xt)}finally{nt!==null&&St.types!==null&&(nt.types=St.types),L.T=nt}},te.unstable_useCacheRefresh=function(){return L.H.useCacheRefresh()},te.use=function(U){return L.H.use(U)},te.useActionState=function(U,nt,St){return L.H.useActionState(U,nt,St)},te.useCallback=function(U,nt){return L.H.useCallback(U,nt)},te.useContext=function(U){return L.H.useContext(U)},te.useDebugValue=function(){},te.useDeferredValue=function(U,nt){return L.H.useDeferredValue(U,nt)},te.useEffect=function(U,nt){return L.H.useEffect(U,nt)},te.useEffectEvent=function(U){return L.H.useEffectEvent(U)},te.useId=function(){return L.H.useId()},te.useImperativeHandle=function(U,nt,St){return L.H.useImperativeHandle(U,nt,St)},te.useInsertionEffect=function(U,nt){return L.H.useInsertionEffect(U,nt)},te.useLayoutEffect=function(U,nt){return L.H.useLayoutEffect(U,nt)},te.useMemo=function(U,nt){return L.H.useMemo(U,nt)},te.useOptimistic=function(U,nt){return L.H.useOptimistic(U,nt)},te.useReducer=function(U,nt,St){return L.H.useReducer(U,nt,St)},te.useRef=function(U){return L.H.useRef(U)},te.useState=function(U){return L.H.useState(U)},te.useSyncExternalStore=function(U,nt,St){return L.H.useSyncExternalStore(U,nt,St)},te.useTransition=function(){return L.H.useTransition()},te.version="19.2.3",te}var n_;function od(){return n_||(n_=1,Wf.exports=JS()),Wf.exports}var an=od(),Yf={exports:{}},To={},Zf={exports:{}},jf={};var i_;function $S(){return i_||(i_=1,(function(o){function e(O,q){var Z=O.length;O.push(q);t:for(;0<Z;){var Mt=Z-1>>>1,Et=O[Mt];if(0<l(Et,q))O[Mt]=q,O[Z]=Et,Z=Mt;else break t}}function i(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var q=O[0],Z=O.pop();if(Z!==q){O[0]=Z;t:for(var Mt=0,Et=O.length,U=Et>>>1;Mt<U;){var nt=2*(Mt+1)-1,St=O[nt],W=nt+1,ot=O[W];if(0>l(St,Z))W<Et&&0>l(ot,St)?(O[Mt]=ot,O[W]=Z,Mt=W):(O[Mt]=St,O[nt]=Z,Mt=nt);else if(W<Et&&0>l(ot,Z))O[Mt]=ot,O[W]=Z,Mt=W;else break t}}return q}function l(O,q){var Z=O.sortIndex-q.sortIndex;return Z!==0?Z:O.id-q.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;o.unstable_now=function(){return c.now()}}else{var h=Date,d=h.now();o.unstable_now=function(){return h.now()-d}}var m=[],p=[],_=1,v=null,x=3,y=!1,A=!1,R=!1,M=!1,S=typeof setTimeout=="function"?setTimeout:null,z=typeof clearTimeout=="function"?clearTimeout:null,D=typeof setImmediate<"u"?setImmediate:null;function P(O){for(var q=i(p);q!==null;){if(q.callback===null)r(p);else if(q.startTime<=O)r(p),q.sortIndex=q.expirationTime,e(m,q);else break;q=i(p)}}function et(O){if(R=!1,P(O),!A)if(i(m)!==null)A=!0,F||(F=!0,lt());else{var q=i(p);q!==null&&ht(et,q.startTime-O)}}var F=!1,L=-1,j=5,w=-1;function C(){return M?!0:!(o.unstable_now()-w<j)}function G(){if(M=!1,F){var O=o.unstable_now();w=O;var q=!0;try{t:{A=!1,R&&(R=!1,z(L),L=-1),y=!0;var Z=x;try{e:{for(P(O),v=i(m);v!==null&&!(v.expirationTime>O&&C());){var Mt=v.callback;if(typeof Mt=="function"){v.callback=null,x=v.priorityLevel;var Et=Mt(v.expirationTime<=O);if(O=o.unstable_now(),typeof Et=="function"){v.callback=Et,P(O),q=!0;break e}v===i(m)&&r(m),P(O)}else r(m);v=i(m)}if(v!==null)q=!0;else{var U=i(p);U!==null&&ht(et,U.startTime-O),q=!1}}break t}finally{v=null,x=Z,y=!1}q=void 0}}finally{q?lt():F=!1}}}var lt;if(typeof D=="function")lt=function(){D(G)};else if(typeof MessageChannel<"u"){var at=new MessageChannel,ct=at.port2;at.port1.onmessage=G,lt=function(){ct.postMessage(null)}}else lt=function(){S(G,0)};function ht(O,q){L=S(function(){O(o.unstable_now())},q)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(O){O.callback=null},o.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):j=0<O?Math.floor(1e3/O):5},o.unstable_getCurrentPriorityLevel=function(){return x},o.unstable_next=function(O){switch(x){case 1:case 2:case 3:var q=3;break;default:q=x}var Z=x;x=q;try{return O()}finally{x=Z}},o.unstable_requestPaint=function(){M=!0},o.unstable_runWithPriority=function(O,q){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var Z=x;x=O;try{return q()}finally{x=Z}},o.unstable_scheduleCallback=function(O,q,Z){var Mt=o.unstable_now();switch(typeof Z=="object"&&Z!==null?(Z=Z.delay,Z=typeof Z=="number"&&0<Z?Mt+Z:Mt):Z=Mt,O){case 1:var Et=-1;break;case 2:Et=250;break;case 5:Et=1073741823;break;case 4:Et=1e4;break;default:Et=5e3}return Et=Z+Et,O={id:_++,callback:q,priorityLevel:O,startTime:Z,expirationTime:Et,sortIndex:-1},Z>Mt?(O.sortIndex=Z,e(p,O),i(m)===null&&O===i(p)&&(R?(z(L),L=-1):R=!0,ht(et,Z-Mt))):(O.sortIndex=Et,e(m,O),A||y||(A=!0,F||(F=!0,lt()))),O},o.unstable_shouldYield=C,o.unstable_wrapCallback=function(O){var q=x;return function(){var Z=x;x=q;try{return O.apply(this,arguments)}finally{x=Z}}}})(jf)),jf}var a_;function tx(){return a_||(a_=1,Zf.exports=$S()),Zf.exports}var Kf={exports:{}},En={};var r_;function ex(){if(r_)return En;r_=1;var o=od();function e(m){var p="https://react.dev/errors/"+m;if(1<arguments.length){p+="?args[]="+encodeURIComponent(arguments[1]);for(var _=2;_<arguments.length;_++)p+="&args[]="+encodeURIComponent(arguments[_])}return"Minified React error #"+m+"; visit "+p+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function i(){}var r={d:{f:i,r:function(){throw Error(e(522))},D:i,C:i,L:i,m:i,X:i,S:i,M:i},p:0,findDOMNode:null},l=Symbol.for("react.portal");function c(m,p,_){var v=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:l,key:v==null?null:""+v,children:m,containerInfo:p,implementation:_}}var h=o.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function d(m,p){if(m==="font")return"";if(typeof p=="string")return p==="use-credentials"?p:""}return En.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=r,En.createPortal=function(m,p){var _=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!p||p.nodeType!==1&&p.nodeType!==9&&p.nodeType!==11)throw Error(e(299));return c(m,p,null,_)},En.flushSync=function(m){var p=h.T,_=r.p;try{if(h.T=null,r.p=2,m)return m()}finally{h.T=p,r.p=_,r.d.f()}},En.preconnect=function(m,p){typeof m=="string"&&(p?(p=p.crossOrigin,p=typeof p=="string"?p==="use-credentials"?p:"":void 0):p=null,r.d.C(m,p))},En.prefetchDNS=function(m){typeof m=="string"&&r.d.D(m)},En.preinit=function(m,p){if(typeof m=="string"&&p&&typeof p.as=="string"){var _=p.as,v=d(_,p.crossOrigin),x=typeof p.integrity=="string"?p.integrity:void 0,y=typeof p.fetchPriority=="string"?p.fetchPriority:void 0;_==="style"?r.d.S(m,typeof p.precedence=="string"?p.precedence:void 0,{crossOrigin:v,integrity:x,fetchPriority:y}):_==="script"&&r.d.X(m,{crossOrigin:v,integrity:x,fetchPriority:y,nonce:typeof p.nonce=="string"?p.nonce:void 0})}},En.preinitModule=function(m,p){if(typeof m=="string")if(typeof p=="object"&&p!==null){if(p.as==null||p.as==="script"){var _=d(p.as,p.crossOrigin);r.d.M(m,{crossOrigin:_,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0})}}else p==null&&r.d.M(m)},En.preload=function(m,p){if(typeof m=="string"&&typeof p=="object"&&p!==null&&typeof p.as=="string"){var _=p.as,v=d(_,p.crossOrigin);r.d.L(m,_,{crossOrigin:v,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0,type:typeof p.type=="string"?p.type:void 0,fetchPriority:typeof p.fetchPriority=="string"?p.fetchPriority:void 0,referrerPolicy:typeof p.referrerPolicy=="string"?p.referrerPolicy:void 0,imageSrcSet:typeof p.imageSrcSet=="string"?p.imageSrcSet:void 0,imageSizes:typeof p.imageSizes=="string"?p.imageSizes:void 0,media:typeof p.media=="string"?p.media:void 0})}},En.preloadModule=function(m,p){if(typeof m=="string")if(p){var _=d(p.as,p.crossOrigin);r.d.m(m,{as:typeof p.as=="string"&&p.as!=="script"?p.as:void 0,crossOrigin:_,integrity:typeof p.integrity=="string"?p.integrity:void 0})}else r.d.m(m)},En.requestFormReset=function(m){r.d.r(m)},En.unstable_batchedUpdates=function(m,p){return m(p)},En.useFormState=function(m,p,_){return h.H.useFormState(m,p,_)},En.useFormStatus=function(){return h.H.useHostTransitionStatus()},En.version="19.2.3",En}var s_;function nx(){if(s_)return Kf.exports;s_=1;function o(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(o)}catch(e){console.error(e)}}return o(),Kf.exports=ex(),Kf.exports}var o_;function ix(){if(o_)return To;o_=1;var o=tx(),e=od(),i=nx();function r(t){var n="https://react.dev/errors/"+t;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+t+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(t){return!(!t||t.nodeType!==1&&t.nodeType!==9&&t.nodeType!==11)}function c(t){var n=t,a=t;if(t.alternate)for(;n.return;)n=n.return;else{t=n;do n=t,(n.flags&4098)!==0&&(a=n.return),t=n.return;while(t)}return n.tag===3?a:null}function h(t){if(t.tag===13){var n=t.memoizedState;if(n===null&&(t=t.alternate,t!==null&&(n=t.memoizedState)),n!==null)return n.dehydrated}return null}function d(t){if(t.tag===31){var n=t.memoizedState;if(n===null&&(t=t.alternate,t!==null&&(n=t.memoizedState)),n!==null)return n.dehydrated}return null}function m(t){if(c(t)!==t)throw Error(r(188))}function p(t){var n=t.alternate;if(!n){if(n=c(t),n===null)throw Error(r(188));return n!==t?null:t}for(var a=t,s=n;;){var u=a.return;if(u===null)break;var f=u.alternate;if(f===null){if(s=u.return,s!==null){a=s;continue}break}if(u.child===f.child){for(f=u.child;f;){if(f===a)return m(u),t;if(f===s)return m(u),n;f=f.sibling}throw Error(r(188))}if(a.return!==s.return)a=u,s=f;else{for(var g=!1,E=u.child;E;){if(E===a){g=!0,a=u,s=f;break}if(E===s){g=!0,s=u,a=f;break}E=E.sibling}if(!g){for(E=f.child;E;){if(E===a){g=!0,a=f,s=u;break}if(E===s){g=!0,s=f,a=u;break}E=E.sibling}if(!g)throw Error(r(189))}}if(a.alternate!==s)throw Error(r(190))}if(a.tag!==3)throw Error(r(188));return a.stateNode.current===a?t:n}function _(t){var n=t.tag;if(n===5||n===26||n===27||n===6)return t;for(t=t.child;t!==null;){if(n=_(t),n!==null)return n;t=t.sibling}return null}var v=Object.assign,x=Symbol.for("react.element"),y=Symbol.for("react.transitional.element"),A=Symbol.for("react.portal"),R=Symbol.for("react.fragment"),M=Symbol.for("react.strict_mode"),S=Symbol.for("react.profiler"),z=Symbol.for("react.consumer"),D=Symbol.for("react.context"),P=Symbol.for("react.forward_ref"),et=Symbol.for("react.suspense"),F=Symbol.for("react.suspense_list"),L=Symbol.for("react.memo"),j=Symbol.for("react.lazy"),w=Symbol.for("react.activity"),C=Symbol.for("react.memo_cache_sentinel"),G=Symbol.iterator;function lt(t){return t===null||typeof t!="object"?null:(t=G&&t[G]||t["@@iterator"],typeof t=="function"?t:null)}var at=Symbol.for("react.client.reference");function ct(t){if(t==null)return null;if(typeof t=="function")return t.$$typeof===at?null:t.displayName||t.name||null;if(typeof t=="string")return t;switch(t){case R:return"Fragment";case S:return"Profiler";case M:return"StrictMode";case et:return"Suspense";case F:return"SuspenseList";case w:return"Activity"}if(typeof t=="object")switch(t.$$typeof){case A:return"Portal";case D:return t.displayName||"Context";case z:return(t._context.displayName||"Context")+".Consumer";case P:var n=t.render;return t=t.displayName,t||(t=n.displayName||n.name||"",t=t!==""?"ForwardRef("+t+")":"ForwardRef"),t;case L:return n=t.displayName||null,n!==null?n:ct(t.type)||"Memo";case j:n=t._payload,t=t._init;try{return ct(t(n))}catch{}}return null}var ht=Array.isArray,O=e.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,q=i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,Z={pending:!1,data:null,method:null,action:null},Mt=[],Et=-1;function U(t){return{current:t}}function nt(t){0>Et||(t.current=Mt[Et],Mt[Et]=null,Et--)}function St(t,n){Et++,Mt[Et]=t.current,t.current=n}var W=U(null),ot=U(null),xt=U(null),yt=U(null);function Ft(t,n){switch(St(xt,n),St(ot,t),St(W,null),n.nodeType){case 9:case 11:t=(t=n.documentElement)&&(t=t.namespaceURI)?yg(t):0;break;default:if(t=n.tagName,n=n.namespaceURI)n=yg(n),t=Eg(n,t);else switch(t){case"svg":t=1;break;case"math":t=2;break;default:t=0}}nt(W),St(W,t)}function It(){nt(W),nt(ot),nt(xt)}function ee(t){t.memoizedState!==null&&St(yt,t);var n=W.current,a=Eg(n,t.type);n!==a&&(St(ot,t),St(W,a))}function Le(t){ot.current===t&&(nt(W),nt(ot)),yt.current===t&&(nt(yt),So._currentValue=Z)}var I,Ve;function ue(t){if(I===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);I=n&&n[1]||"",Ve=-1<a.stack.indexOf(`
    at`)?" (<anonymous>)":-1<a.stack.indexOf("@")?"@unknown:0:0":""}return`
`+I+t+Ve}var Se=!1;function Vt(t,n){if(!t||Se)return"";Se=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var s={DetermineComponentFrameRoot:function(){try{if(n){var pt=function(){throw Error()};if(Object.defineProperty(pt.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(pt,[])}catch(st){var J=st}Reflect.construct(t,[],pt)}else{try{pt.call()}catch(st){J=st}t.call(pt.prototype)}}else{try{throw Error()}catch(st){J=st}(pt=t())&&typeof pt.catch=="function"&&pt.catch(function(){})}}catch(st){if(st&&J&&typeof st.stack=="string")return[st.stack,J.stack]}return[null,null]}};s.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var u=Object.getOwnPropertyDescriptor(s.DetermineComponentFrameRoot,"name");u&&u.configurable&&Object.defineProperty(s.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var f=s.DetermineComponentFrameRoot(),g=f[0],E=f[1];if(g&&E){var B=g.split(`
`),Q=E.split(`
...
`)+`
`+S);const D=z+M+h,P=z+S+d,et=Z_(l,l.VERTEX_SHADER,D),F=Z_(l,l.FRAGMENT_SHADER,P);l.attachShader(R,et),l.attachShader(R,F),i.index0AttributeName!==void 0?l.bindAttribLocation(R,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(R,0,"position"),l.linkProgram(R);function L(G){if(o.debug.checkShaderErrors){const lt=l.getProgramInfoLog(R).trim(),at=l.getShaderInfoLog(et).trim(),ct=l.getShaderInfoLog(F).trim();let ht=!0,O=!0;if(l.getProgramParameter(R,l.LINK_STATUS)===!1)if(ht=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,R,et,F);else{const q=j_(l,et,"vertex"),Z=j_(l,F,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(R,l.VALIDATE_STATUS)+`
	...
	if ( coord.x >= 1.0 ) {
...
}`;class ob{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,i,r){if(this.texture===null){const l=new In,c=e.properties.get(l);c.__webglTexture=i.texture,(i.depthNear!=r.depthNear||i.depthFar!=r.depthFar)&&(this.depthNear=i.depthNear,this.depthFar=i.depthFar),this.texture=l}}getMesh(e){if(this.texture!==null&&this.mesh===null){const i=e.cameras[0].viewport,r=new na({vertexShader:rb,fragmentShader:sb,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new Ri(new Ho(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class lb extends Rs{constructor(e,i){super();const r=this;let l=null,c=1,h=null,d="local-floor",m=1,p=null,_=null,v=null,x=null,y=null,A=null;const R=new ob,M=i.getContextAttributes();let S=null,z=null;const D=[],P=[],et=new Ee;let F=null;const L=new mi;L.layers.enable(1),L.viewport=new dn;const j=new mi;j.layers.enable(2),j.viewport=new dn;const w=[L,j],C=new ib;C.layers.enable(1),C.layers.enable(2);let G=null,lt=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(W){let ot=D[W];return ot===void 0&&(ot=new Th,D[W]=ot),ot.getTargetRaySpace()},this.getControllerGrip=function(W){let ot=D[W];return ot===void 0&&(ot=new Th,D[W]=ot),ot.getGripSpace()},this.getHand=function(W){let ot=D[W];return ot===void 0&&(ot=new Th,D[W]=ot),ot.getHandSpace()};function at(W){const ot=P.indexOf(W.inputSource);if(ot===-1)return;const xt=D[ot];xt!==void 0&&(xt.update(W.inputSource,W.frame,p||h),xt.dispatchEvent({type:W.type,data:W.inputSource}))}function ct(){l.removeEventListener("select",at),l.removeEventListener("selectstart",at),l.removeEventListener("selectend",at),l.removeEventListener("squeeze",at),l.removeEventListener("squeezestart",at),l.removeEventListener("squeezeend",at),l.removeEventListener("end",ct),l.removeEventListener("inputsourceschange",ht);for(let W=0;W<D.length;W++){const ot=P[W];ot!==null&&(P[W]=null,D[W].disconnect(ot))}G=null,lt=null,R.reset(),e.setRenderTarget(S),y=null,x=null,v=null,l=null,z=null,St.stop(),r.isPresenting=!1,e.setPixelRatio(F),e.setSize(et.width,et.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(W){c=W,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(W){d=W,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||h},this.setReferenceSpace=function(W){p=W},this.getBaseLayer=function(){return x!==null?x:y},this.getBinding=function(){return v},this.getFrame=function(){return A},this.getSession=function(){return l},this.setSession=async function(W){if(l=W,l!==null){if(S=e.getRenderTarget(),l.addEventListener("select",at),l.addEventListener("selectstart",at),l.addEventListener("selectend",at),l.addEventListener("squeeze",at),l.addEventListener("squeezestart",at),l.addEventListener("squeezeend",at),l.addEventListener("end",ct),l.addEventListener("inputsourceschange",ht),M.xrCompatible!==!0&&await i.makeXRCompatible(),F=e.getPixelRatio(),e.getSize(et),l.renderState.layers===void 0){const ot={antialias:M.antialias,alpha:!0,depth:M.depth,stencil:M.stencil,framebufferScaleFactor:c};y=new XRWebGLLayer(l,i,ot),l.updateRenderState({baseLayer:y}),e.setPixelRatio(1),e.setSize(y.framebufferWidth,y.framebufferHeight,!1),z=new Sr(y.framebufferWidth,y.framebufferHeight,{format:_i,type:ta,colorSpace:e.outputColorSpace,stencilBuffer:M.stencil})}else{let ot=null,xt=null,yt=null;M.depth&&(yt=M.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,ot=M.stencil?As:xs,xt=M.stencil?Ts:vr);const Ft={colorFormat:i.RGBA8,depthFormat:yt,scaleFactor:c};v=new XRWebGLBinding(l,i),x=v.createProjectionLayer(Ft),l.updateRenderState({layers:[x]}),e.setPixelRatio(1),e.setSize(x.textureWidth,x.textureHeight,!1),z=new Sr(x.textureWidth,x.textureHeight,{format:_i,type:ta,depthTexture:new F0(x.textureWidth,x.textureHeight,xt,void 0,void 0,void 0,void 0,void 0,void 0,ot),stencilBuffer:M.stencil,colorSpace:e.outputColorSpace,samples:M.antialias?4:0,resolveDepthBuffer:x.ignoreDepthValues===!1})}z.isXRRenderTarget=!0,this.setFoveation(m),p=null,h=await l.requestReferenceSpace(d),St.setContext(l),St.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return R.getDepthTexture()};function ht(W){for(let ot=0;ot<W.removed.length;ot++){const xt=W.removed[ot],yt=P.indexOf(xt);yt>=0&&(P[yt]=null,D[yt].disconnect(xt))}for(let ot=0;ot<W.added.length;ot++){const xt=W.added[ot];let yt=P.indexOf(xt);if(yt===-1){for(let It=0;It<D.length;It++)if(It>=P.length){P.push(xt),yt=It;break}else if(P[It]===null){P[It]=xt,yt=It;break}if(yt===-1)break}const Ft=D[yt];Ft&&Ft.connect(xt)}}const O=new it,q=new it;function Z(W,ot,xt){O.setFromMatrixPosition(ot.matrixWorld),q.setFromMatrixPosition(xt.matrixWorld);const yt=O.distanceTo(q),Ft=ot.projectionMatrix.elements,It=xt.projectionMatrix.elements,ee=Ft[14]/(Ft[10]-1),Le=Ft[14]/(Ft[10]+1),I=(Ft[9]+1)/Ft[5],Ve=(Ft[9]-1)/Ft[5],ue=(Ft[8]-1)/Ft[0],Se=(It[8]+1)/It[0],Vt=ee*ue,Xe=ee*Se,Jt=yt/(-ue+Se),$t=Jt*-ue;if(ot.matrixWorld.decompose(W.position,W.quaternion,W.scale),W.translateX($t),W.translateZ(Jt),W.matrixWorld.compose(W.position,W.quaternion,W.scale),W.matrixWorldInverse.copy(W.matrixWorld).invert(),Ft[10]===-1)W.projectionMatrix.copy(ot.projectionMatrix),W.projectionMatrixInverse.copy(ot.projectionMatrixInverse);else{const N=ee+Jt,T=Le+Jt,rt=Vt-$t,_t=Xe+(yt-$t),mt=I*Le/T*N,vt=Ve*Le/T*N;W.projectionMatrix.makePerspective(rt,_t,mt,vt,N,T),W.projectionMatrixInverse.copy(W.projectionMatrix).invert()}}function Mt(W,ot){ot===null?W.matrixWorld.copy(W.matrix):W.matrixWorld.multiplyMatrices(ot.matrixWorld,W.matrix),W.matrixWorldInverse.copy(W.matrixWorld).invert()}this.updateCamera=function(W){if(l===null)return;let ot=W.near,xt=W.far;R.texture!==null&&(R.depthNear>0&&(ot=R.depthNear),R.depthFar>0&&(xt=R.depthFar)),C.near=j.near=L.near=ot,C.far=j.far=L.far=xt,(G!==C.near||lt!==C.far)&&(l.updateRenderState({depthNear:C.near,depthFar:C.far}),G=C.near,lt=C.far);const yt=W.parent,Ft=C.cameras;Mt(C,yt);for(let It=0;It<Ft.length;It++)Mt(Ft[It],yt);Ft.length===2?Z(C,L,j):C.projectionMatrix.copy(L.projectionMatrix),Et(W,C,yt)};function Et(W,ot,xt){xt===null?W.matrix.copy(ot.matrixWorld):(W.matrix.copy(xt.matrixWorld),W.matrix.invert(),W.matrix.multiply(ot.matrixWorld)),W.matrix.decompose(W.position,W.quaternion,W.scale),W.updateMatrixWorld(!0),W.projectionMatrix.copy(ot.projectionMatrix),W.projectionMatrixInverse.copy(ot.projectionMatrixInverse),W.isPerspectiveCamera&&(W.fov=ad*2*Math.atan(1/W.projectionMatrix.elements[5]),W.zoom=1)}this.getCamera=function(){return C},this.getFoveation=function(){if(!(x===null&&y===null))return m},this.setFoveation=function(W){m=W,x!==null&&(x.fixedFoveation=W),y!==null&&y.fixedFoveation!==void 0&&(y.fixedFoveation=W)},this.hasDepthSensing=function(){return R.texture!==null},this.getDepthSensingMesh=function(){return R.getMesh(C)};let U=null;function nt(W,ot){if(_=ot.getViewerPose(p||h),A=ot,_!==null){const xt=_.views;y!==null&&(e.setRenderTargetFramebuffer(z,y.framebuffer),e.setRenderTarget(z));let yt=!1;xt.length!==C.cameras.length&&(C.cameras.length=0,yt=!0);for(let It=0;It<xt.length;It++){const ee=xt[It];let Le=null;if(y!==null)Le=y.getViewport(ee);else{const Ve=v.getViewSubImage(x,ee);Le=Ve.viewport,It===0&&(e.setRenderTargetTextures(z,Ve.colorTexture,x.ignoreDepthValues?void 0:Ve.depthStencilTexture),e.setRenderTarget(z))}let I=w[It];I===void 0&&(I=new mi,I.layers.enable(It),I.viewport=new dn,w[It]=I),I.matrix.fromArray(ee.transform.matrix),I.matrix.decompose(I.position,I.quaternion,I.scale),I.projectionMatrix.fromArray(ee.projectionMatrix),I.projectionMatrixInverse.copy(I.projectionMatrix).invert(),I.viewport.set(Le.x,Le.y,Le.width,Le.height),It===0&&(C.matrix.copy(I.matrix),C.matrix.decompose(C.position,C.quaternion,C.scale)),yt===!0&&C.cameras.push(I)}const Ft=l.enabledFeatures;if(Ft&&Ft.includes("depth-sensing")){const It=v.getDepthInformation(xt[0]);It&&It.isValid&&It.texture&&R.init(e,It,l.renderState)}}for(let xt=0;xt<D.length;xt++){const yt=P[xt],Ft=D[xt];yt!==null&&Ft!==void 0&&Ft.update(yt,ot,p||h)}U&&U(W,ot),ot.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:ot}),A=null}const St=new B0;St.setAnimationLoop(nt),this.setAnimationLoop=function(W){U=W},this.dispose=function(){}}}const ur=new ea,ub=new rn;function cb(o,e){function i(M,S){M.matrixAutoUpdate===!0&&M.updateMatrix(),S.value.copy(M.matrix)}function r(M,S){S.color.getRGB(M.fogColor.value,N0(o)),S.isFog?(M.fogNear.value=S.near,M.fogFar.value=S.far):S.isFogExp2&&(M.fogDensity.value=S.density)}function l(M,S,z,D,P){S.isMeshBasicMaterial||S.isMeshLambertMaterial?c(M,S):S.isMeshToonMaterial?(c(M,S),v(M,S)):S.isMeshPhongMaterial?(c(M,S),_(M,S)):S.isMeshStandardMaterial?(c(M,S),x(M,S),S.isMeshPhysicalMaterial&&y(M,S,P)):S.isMeshMatcapMaterial?(c(M,S),A(M,S)):S.isMeshDepthMaterial?c(M,S):S.isMeshDistanceMaterial?(c(M,S),R(M,S)):S.isMeshNormalMaterial?c(M,S):S.isLineBasicMaterial?(h(M,S),S.isLineDashedMaterial&&d(M,S)):S.isPointsMaterial?m(M,S,z,D):S.isSpriteMaterial?p(M,S):S.isShadowMaterial?(M.color.value.copy(S.color),M.opacity.value=S.opacity):S.isShaderMaterial&&(S.uniformsNeedUpdate=!1)}function c(M,S){M.opacity.value=S.opacity,S.color&&M.diffuse.value.copy(S.color),S.emissive&&M.emissive.value.copy(S.emissive).multiplyScalar(S.emissiveIntensity),S.map&&(M.map.value=S.map,i(S.map,M.mapTransform)),S.alphaMap&&(M.alphaMap.value=S.alphaMap,i(S.alphaMap,M.alphaMapTransform)),S.bumpMap&&(M.bumpMap.value=S.bumpMap,i(S.bumpMap,M.bumpMapTransform),M.bumpScale.value=S.bumpScale,S.side===Bn&&(M.bumpScale.value*=-1)),S.normalMap&&(M.normalMap.value=S.normalMap,i(S.normalMap,M.normalMapTransform),M.normalScale.value.copy(S.normalScale),S.side===Bn&&M.normalScale.value.negate()),S.displacementMap&&(M.displacementMap.value=S.displacementMap,i(S.displacementMap,M.displacementMapTransform),M.displacementScale.value=S.displacementScale,M.displacementBias.value=S.displacementBias),S.emissiveMap&&(M.emissiveMap.value=S.emissiveMap,i(S.emissiveMap,M.emissiveMapTransform)),S.specularMap&&(M.specularMap.value=S.specularMap,i(S.specularMap,M.specularMapTransform)),S.alphaTest>0&&(M.alphaTest.value=S.alphaTest);const z=e.get(S),D=z.envMap,P=z.envMapRotation;D&&(M.envMap.value=D,ur.copy(P),ur.x*=-1,ur.y*=-1,ur.z*=-1,D.isCubeTexture&&D.isRenderTargetTexture===!1&&(ur.y*=-1,ur.z*=-1),M.envMapRotation.value.setFromMatrix4(ub.makeRotationFromEuler(ur)),M.flipEnvMap.value=D.isCubeTexture&&D.isRenderTargetTexture===!1?-1:1,M.reflectivity.value=S.reflectivity,M.ior.value=S.ior,M.refractionRatio.value=S.refractionRatio),S.lightMap&&(M.lightMap.value=S.lightMap,M.lightMapIntensity.value=S.lightMapIntensity,i(S.lightMap,M.lightMapTransform)),S.aoMap&&(M.aoMap.value=S.aoMap,M.aoMapIntensity.value=S.aoMapIntensity,i(S.aoMap,M.aoMapTransform))}function h(M,S){M.diffuse.value.copy(S.color),M.opacity.value=S.opacity,S.map&&(M.map.value=S.map,i(S.map,M.mapTransform))}function d(M,S){M.dashSize.value=S.dashSize,M.totalSize.value=S.dashSize+S.gapSize,M.scale.value=S.scale}function m(M,S,z,D){M.diffuse.value.copy(S.color),M.opacity.value=S.opacity,M.size.value=S.size*z,M.scale.value=D*.5,S.map&&(M.map.value=S.map,i(S.map,M.uvTransform)),S.alphaMap&&(M.alphaMap.value=S.alphaMap,i(S.alphaMap,M.alphaMapTransform)),S.alphaTest>0&&(M.alphaTest.value=S.alphaTest)}function p(M,S){M.diffuse.value.copy(S.color),M.opacity.value=S.opacity,M.rotation.value=S.rotation,S.map&&(M.map.value=S.map,i(S.map,M.mapTransform)),S.alphaMap&&(M.alphaMap.value=S.alphaMap,i(S.alphaMap,M.alphaMapTransform)),S.alphaTest>0&&(M.alphaTest.value=S.alphaTest)}function _(M,S){M.specular.value.copy(S.specular),M.shininess.value=Math.max(S.shininess,1e-4)}function v(M,S){S.gradientMap&&(M.gradientMap.value=S.gradientMap)}function x(M,S){M.metalness.value=S.metalness,S.metalnessMap&&(M.metalnessMap.value=S.metalnessMap,i(S.metalnessMap,M.metalnessMapTransform)),M.roughness.value=S.roughness,S.roughnessMap&&(M.roughnessMap.value=S.roughnessMap,i(S.roughnessMap,M.roughnessMapTransform)),S.envMap&&(M.envMapIntensity.value=S.envMapIntensity)}function y(M,S,z){M.ior.value=S.ior,S.sheen>0&&(M.sheenColor.value.copy(S.sheenColor).multiplyScalar(S.sheen),M.sheenRoughness.value=S.sheenRoughness,S.sheenColorMap&&(M.sheenColorMap.value=S.sheenColorMap,i(S.sheenColorMap,M.sheenColorMapTransform)),S.sheenRoughnessMap&&(M.sheenRoughnessMap.value=S.sheenRoughnessMap,i(S.sheenRoughnessMap,M.sheenRoughnessMapTransform))),S.clearcoat>0&&(M.clearcoat.value=S.clearcoat,M.clearcoatRoughness.value=S.clearcoatRoughness,S.clearcoatMap&&(M.clearcoatMap.value=S.clearcoatMap,i(S.clearcoatMap,M.clearcoatMapTransform)),S.clearcoatRoughnessMap&&(M.clearcoatRoughnessMap.value=S.clearcoatRoughnessMap,i(S.clearcoatRoughnessMap,M.clearcoatRoughnessMapTransform)),S.clearcoatNormalMap&&(M.clearcoatNormalMap.value=S.clearcoatNormalMap,i(S.clearcoatNormalMap,M.clearcoatNormalMapTransform),M.clearcoatNormalScale.value.copy(S.clearcoatNormalScale),S.side===Bn&&M.clearcoatNormalScale.value.negate())),S.dispersion>0&&(M.dispersion.value=S.dispersion),S.iridescence>0&&(M.iridescence.value=S.iridescence,M.iridescenceIOR.value=S.iridescenceIOR,M.iridescenceThicknessMinimum.value=S.iridescenceThicknessRange[0],M.iridescenceThicknessMaximum.value=S.iridescenceThicknessRange[1],S.iridescenceMap&&(M.iridescenceMap.value=S.iridescenceMap,i(S.iridescenceMap,M.iridescenceMapTransform)),S.iridescenceThicknessMap&&(M.iridescenceThicknessMap.value=S.iridescenceThicknessMap,i(S.iridescenceThicknessMap,M.iridescenceThicknessMapTransform))),S.transmission>0&&(M.transmission.value=S.transmission,M.transmissionSamplerMap.value=z.texture,M.transmissionSamplerSize.value.set(z.width,z.height),S.transmissionMap&&(M.transmissionMap.value=S.transmissionMap,i(S.transmissionMap,M.transmissionMapTransform)),M.thickness.value=S.thickness,S.thicknessMap&&(M.thicknessMap.value=S.thicknessMap,i(S.thicknessMap,M.thicknessMapTransform)),M.attenuationDistance.value=S.attenuationDistance,M.attenuationColor.value.copy(S.attenuationColor)),S.anisotropy>0&&(M.anisotropyVector.value.set(S.anisotropy*Math.cos(S.anisotropyRotation),S.anisotropy*Math.sin(S.anisotropyRotation)),S.anisotropyMap&&(M.anisotropyMap.value=S.anisotropyMap,i(S.anisotropyMap,M.anisotropyMapTransform))),M.specularIntensity.value=S.specularIntensity,M.specularColor.value.copy(S.specularColor),S.specularColorMap&&(M.specularColorMap.value=S.specularColorMap,i(S.specularColorMap,M.specularColorMapTransform)),S.specularIntensityMap&&(M.specularIntensityMap.value=S.specularIntensityMap,i(S.specularIntensityMap,M.specularIntensityMapTransform))}function A(M,S){S.matcap&&(M.matcap.value=S.matcap)}function R(M,S){const z=e.get(S).light;M.referencePosition.value.setFromMatrixPosition(z.matrixWorld),M.nearDistance.value=z.shadow.camera.near,M.farDistance.value=z.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:l}}function fb(o,e,i,r){let l={},c={},h=[];const d=o.getParameter(o.MAX_UNIFORM_BUFFER_BINDINGS);function m(z,D){const P=D.program;r.uniformBlockBinding(z,P)}function p(z,D){let P=l[z.id];P===void 0&&(A(z),P=_(z),l[z.id]=P,z.addEventListener("dispose",M));const et=D.program;r.updateUBOMapping(z,et);const F=e.render.frame;c[z.id]!==F&&(x(z),c[z.id]=F)}function _(z){const D=v();z.__bindingPointIndex=D;const P=o.createBuffer(),et=z.__size,F=z.usage;return o.bindBuffer(o.UNIFORM_BUFFER,P),o.bufferData(o.UNIFORM_BUFFER,et,F),o.bindBuffer(o.UNIFORM_BUFFER,null),o.bindBufferBase(o.UNIFORM_BUFFER,D,P),P}function v(){for(let z=0;z<d;z++)if(h.indexOf(z)===-1)return h.push(z),z;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function x(z){const D=l[z.id],P=z.uniforms,et=z.__cache;o.bindBuffer(o.UNIFORM_BUFFER,D);for(let F=0,L=P.length;F<L;F++){const j=Array.isArray(P[F])?P[F]:[P[F]];for(let w=0,C=j.length;w<C;w++){const G=j[w];if(y(G,F,w,et)===!0){const lt=G.__offset,at=Array.isArray(G.value)?G.value:[G.value];let ct=0;for(let ht=0;ht<at.length;ht++){const O=at[ht],q=R(O);typeof O=="number"||typeof O=="boolean"?(G.__data[0]=O,o.bufferSubData(o.UNIFORM_BUFFER,lt+ct,G.__data)):O.isMatrix3?(G.__data[0]=O.elements[0],G.__data[1]=O.elements[1],G.__data[2]=O.elements[2],G.__data[3]=0,G.__data[4]=O.elements[3],G.__data[5]=O.elements[4],G.__data[6]=O.elements[5],G.__data[7]=0,G.__data[8]=O.elements[6],G.__data[9]=O.elements[7],G.__data[10]=O.elements[8],G.__data[11]=0):(O.toArray(G.__data,ct),ct+=q.storage/Float32Array.BYTES_PER_ELEMENT)}o.bufferSubData(o.UNIFORM_BUFFER,lt,G.__data)}}}o.bindBuffer(o.UNIFORM_BUFFER,null)}function y(z,D,P,et){const F=z.value,L=D+"_"+P;if(et[L]===void 0)return typeof F=="number"||typeof F=="boolean"?et[L]=F:et[L]=F.clone(),!0;{const j=et[L];if(typeof F=="number"||typeof F=="boolean"){if(j!==F)return et[L]=F,!0}else if(j.equals(F)===!1)return j.copy(F),!0}return!1}function A(z){const D=z.uniforms;let P=0;const et=16;for(let L=0,j=D.length;L<j;L++){const w=Array.isArray(D[L])?D[L]:[D[L]];for(let C=0,G=w.length;C<G;C++){const lt=w[C],at=Array.isArray(lt.value)?lt.value:[lt.value];for(let ct=0,ht=at.length;ct<ht;ct++){const O=at[ct],q=R(O),Z=P%et,Mt=Z%q.boundary,Et=Z+Mt;P+=Mt,Et!==0&&et-Et<q.storage&&(P+=et-Et),lt.__data=new Float32Array(q.storage/Float32Array.BYTES_PER_ELEMENT),lt.__offset=P,P+=q.storage}}}const F=P%et;return F>0&&(P+=et-F),z.__size=P,z.__cache={},this}function R(z){const D={boundary:0,storage:0};return typeof z=="number"||typeof z=="boolean"?(D.boundary=4,D.storage=4):z.isVector2?(D.boundary=8,D.storage=8):z.isVector3||z.isColor?(D.boundary=16,D.storage=12):z.isVector4?(D.boundary=16,D.storage=16):z.isMatrix3?(D.boundary=48,D.storage=48):z.isMatrix4?(D.boundary=64,D.storage=64):z.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",z),D}function M(z){const D=z.target;D.removeEventListener("dispose",M);const P=h.indexOf(D.__bindingPointIndex);h.splice(P,1),o.deleteBuffer(l[D.id]),delete l[D.id],delete c[D.id]}function S(){for(const z in l)o.deleteBuffer(l[z]);h=[],l={},c={}}return{bind:m,update:p,dispose:S}}class hb{constructor(e={}){const{canvas:i=nM(),context:r=null,depth:l=!0,stencil:c=!1,alpha:h=!1,antialias:d=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:_="default",failIfMajorPerformanceCaveat:v=!1}=e;this.isWebGLRenderer=!0;let x;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=r.getContextAttributes().alpha}else x=h;const y=new Uint32Array(4),A=new Int32Array(4);let R=null,M=null;const S=[],z=[];this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Ti,this.toneMapping=Ia,this.toneMappingExposure=1;const D=this;let P=!1,et=0,F=0,L=null,j=-1,w=null;const C=new dn,G=new dn;let lt=null;const at=new Ae(0);let ct=0,ht=i.width,O=i.height,q=1,Z=null,Mt=null;const Et=new dn(0,0,ht,O),U=new dn(0,0,ht,O);let nt=!1;const St=new z0;let W=!1,ot=!1;const xt=new rn,yt=new it,Ft=new dn,It={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ee=!1;function Le(){return L===null?q:1}let I=r;function Ve(b,X){return i.getContext(b,X)}try{const b={alpha:!0,depth:l,stencil:c,antialias:d,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:_,failIfMajorPerformanceCaveat:v};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${ld}`),i.addEventListener("webglcontextlost",dt,!1),i.addEventListener("webglcontextrestored",gt,!1),i.addEventListener("webglcontextcreationerror",Rt,!1),I===null){const X="webgl2";if(I=Ve(X,b),I===null)throw Ve(X)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(b){throw console.error("THREE.WebGLRenderer: "+b.message),b}let ue,Se,Vt,Xe,Jt,$t,N,T,rt,_t,mt,vt,Wt,Dt,Lt,ne,At,Ot,he,jt,Ct,Yt,Zt,Pe;function V(){ue=new vT(I),ue.init(),Yt=new nb(I,ue),Se=new hT(I,ue,e,Yt),Vt=new $A(I),Xe=new MT(I),Jt=new FA,$t=new eb(I,ue,Vt,Jt,Se,Yt,Xe),N=new pT(D),T=new _T(D),rt=new CM(I),Zt=new cT(I,rt),_t=new ST(I,rt,Xe,Zt),mt=new ET(I,_t,rt,Xe),he=new yT(I,Se,$t),ne=new dT(Jt),vt=new IA(D,N,T,ue,Se,Zt,ne),Wt=new cb(D,Jt),Dt=new GA,Lt=new YA(ue),Ot=new uT(D,N,T,Vt,mt,x,m),At=new JA(D,mt,Se),Pe=new fb(I,Xe,Se,Vt),jt=new fT(I,ue,Xe),Ct=new xT(I,ue,Xe),Xe.programs=vt.programs,D.capabilities=Se,D.extensions=ue,D.properties=Jt,D.renderLists=Dt,D.shadowMap=At,D.state=Vt,D.info=Xe}V();const bt=new lb(D,I);this.xr=bt,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){const b=ue.get("WEBGL_lose_context");b&&b.loseContext()},this.forceContextRestore=function(){const b=ue.get("WEBGL_lose_context");b&&b.restoreContext()},this.getPixelRatio=function(){return q},this.setPixelRatio=function(b){b!==void 0&&(q=b,this.setSize(ht,O,!1))},this.getSize=function(b){return b.set(ht,O)},this.setSize=function(b,X,$=!0){if(bt.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}ht=b,O=X,i.width=Math.floor(b*q),i.height=Math.floor(X*q),$===!0&&(i.style.width=b+"px",i.style.height=X+"px"),this.setViewport(0,0,b,X)},this.getDrawingBufferSize=function(b){return b.set(ht*q,O*q).floor()},this.setDrawingBufferSize=function(b,X,$){ht=b,O=X,q=$,i.width=Math.floor(b*$),i.height=Math.floor(X*$),this.setViewport(0,0,b,X)},this.getCurrentViewport=function(b){return b.copy(C)},this.getViewport=function(b){return b.copy(Et)},this.setViewport=function(b,X,$,tt){b.isVector4?Et.set(b.x,b.y,b.z,b.w):Et.set(b,X,$,tt),Vt.viewport(C.copy(Et).multiplyScalar(q).round())},this.getScissor=function(b){return b.copy(U)},this.setScissor=function(b,X,$,tt){b.isVector4?U.set(b.x,b.y,b.z,b.w):U.set(b,X,$,tt),Vt.scissor(G.copy(U).multiplyScalar(q).round())},this.getScissorTest=function(){return nt},this.setScissorTest=function(b){Vt.setScissorTest(nt=b)},this.setOpaqueSort=function(b){Z=b},this.setTransparentSort=function(b){Mt=b},this.getClearColor=function(b){return b.copy(Ot.getClearColor())},this.setClearColor=function(){Ot.setClearColor.apply(Ot,arguments)},this.getClearAlpha=function(){return Ot.getClearAlpha()},this.setClearAlpha=function(){Ot.setClearAlpha.apply(Ot,arguments)},this.clear=function(b=!0,X=!0,$=!0){let tt=0;if(b){let Y=!1;if(L!==null){const Tt=L.texture.format;Y=Tt===pd||Tt===dd||Tt===hd}if(Y){const Tt=L.texture.type,wt=Tt===ta||Tt===vr||Tt===No||Tt===Ts||Tt===cd||Tt===fd,Pt=Ot.getClearColor(),Nt=Ot.getClearAlpha(),zt=Pt.r,Qt=Pt.g,Gt=Pt.b;wt?(y[0]=zt,y[1]=Qt,y[2]=Gt,y[3]=Nt,I.clearBufferuiv(I.COLOR,0,y)):(A[0]=zt,A[1]=Qt,A[2]=Gt,A[3]=Nt,I.clearBufferiv(I.COLOR,0,A))}else tt|=I.COLOR_BUFFER_BIT}X&&(tt|=I.DEPTH_BUFFER_BIT),$&&(tt|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),I.clear(tt)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",dt,!1),i.removeEventListener("webglcontextrestored",gt,!1),i.removeEventListener("webglcontextcreationerror",Rt,!1),Dt.dispose(),Lt.dispose(),Jt.dispose(),N.dispose(),T.dispose(),mt.dispose(),Zt.dispose(),Pe.dispose(),vt.dispose(),bt.dispose(),bt.removeEventListener("sessionstart",vn),bt.removeEventListener("sessionend",Go),Si.stop()};function dt(b){b.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),P=!0}function gt(){console.log("THREE.WebGLRenderer: Context Restored."),P=!1;const b=Xe.autoReset,X=At.enabled,$=At.autoUpdate,tt=At.needsUpdate,Y=At.type;V(),Xe.autoReset=b,At.enabled=X,At.autoUpdate=$,At.needsUpdate=tt,At.type=Y}function Rt(b){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",b.statusMessage)}function kt(b){const X=b.target;X.removeEventListener("dispose",kt),oe(X)}function oe(b){Oe(b),Jt.remove(b)}function Oe(b){const X=Jt.get(b).programs;X!==void 0&&(X.forEach(function($){vt.releaseProgram($)}),b.isShaderMaterial&&vt.releaseShaderCache(b))}this.renderBufferDirect=function(b,X,$,tt,Y,Tt){X===null&&(X=It);const wt=Y.isMesh&&Y.matrixWorld.determinant()<0,Pt=Sn(b,X,$,tt,Y);Vt.setMaterial(tt,wt);let Nt=$.index,zt=1;if(tt.wireframe===!0){if(Nt=_t.getWireframeAttribute($),Nt===void 0)return;zt=2}const Qt=$.drawRange,Gt=$.attributes.position;let le=Qt.start*zt,be=(Qt.start+Qt.count)*zt;Tt!==null&&(le=Math.max(le,Tt.start*zt),be=Math.min(be,(Tt.start+Tt.count)*zt)),Nt!==null?(le=Math.max(le,0),be=Math.min(be,Nt.count)):Gt!=null&&(le=Math.max(le,0),be=Math.min(be,Gt.count));const Fe=be-le;if(Fe<0||Fe===1/0)return;Zt.setup(Y,tt,Pt,$,Nt);let xn,ve=jt;if(Nt!==null&&(xn=rt.get(Nt),ve=Ct,ve.setIndex(xn)),Y.isMesh)tt.wireframe===!0?(Vt.setLineWidth(tt.wireframeLinewidth*Le()),ve.setMode(I.LINES)):ve.setMode(I.TRIANGLES);else if(Y.isLine){let Xt=tt.linewidth;Xt===void 0&&(Xt=1),Vt.setLineWidth(Xt*Le()),Y.isLineSegments?ve.setMode(I.LINES):Y.isLineLoop?ve.setMode(I.LINE_LOOP):ve.setMode(I.LINE_STRIP)}else Y.isPoints?ve.setMode(I.POINTS):Y.isSprite&&ve.setMode(I.TRIANGLES);if(Y.isBatchedMesh)if(Y._multiDrawInstances!==null)ve.renderMultiDrawInstances(Y._multiDrawStarts,Y._multiDrawCounts,Y._multiDrawCount,Y._multiDrawInstances);else if(ue.get("WEBGL_multi_draw"))ve.renderMultiDraw(Y._multiDrawStarts,Y._multiDrawCounts,Y._multiDrawCount);else{const Xt=Y._multiDrawStarts,ke=Y._multiDrawCounts,me=Y._multiDrawCount,Ye=Nt?rt.get(Nt).bytesPerElement:1,on=Jt.get(tt).currentProgram.getUniforms();for(let Mn=0;Mn<me;Mn++)on.setValue(I,"_gl_DrawID",Mn),ve.render(Xt[Mn]/Ye,ke[Mn])}else if(Y.isInstancedMesh)ve.renderInstances(le,Fe,Y.count);else if($.isInstancedBufferGeometry){const Xt=$._maxInstanceCount!==void 0?$._maxInstanceCount:1/0,ke=Math.min($.instanceCount,Xt);ve.renderInstances(le,Fe,ke)}else ve.render(le,Fe)};function sn(b,X,$){b.transparent===!0&&b.side===Qi&&b.forceSinglePass===!1?(b.side=Bn,b.needsUpdate=!0,Ga(b,X,$),b.side=Fa,b.needsUpdate=!0,Ga(b,X,$),b.side=Qi):Ga(b,X,$)}this.compile=function(b,X,$=null){$===null&&($=b),M=Lt.get($),M.init(X),z.push(M),$.traverseVisible(function(Y){Y.isLight&&Y.layers.test(X.layers)&&(M.pushLight(Y),Y.castShadow&&M.pushShadow(Y))}),b!==$&&b.traverseVisible(function(Y){Y.isLight&&Y.layers.test(X.layers)&&(M.pushLight(Y),Y.castShadow&&M.pushShadow(Y))}),M.setupLights();const tt=new Set;return b.traverse(function(Y){const Tt=Y.material;if(Tt)if(Array.isArray(Tt))for(let wt=0;wt<Tt.length;wt++){const Pt=Tt[wt];sn(Pt,$,Y),tt.add(Pt)}else sn(Tt,$,Y),tt.add(Tt)}),z.pop(),M=null,tt},this.compileAsync=function(b,X,$=null){const tt=this.compile(b,X,$);return new Promise(Y=>{function Tt(){if(tt.forEach(function(wt){Jt.get(wt).currentProgram.isReady()&&tt.delete(wt)}),tt.size===0){Y(b);return}setTimeout(Tt,10)}ue.get("KHR_parallel_shader_compile")!==null?Tt():setTimeout(Tt,10)})};let _e=null;function Hn(b){_e&&_e(b)}function vn(){Si.stop()}function Go(){Si.start()}const Si=new B0;Si.setAnimationLoop(Hn),typeof self<"u"&&Si.setContext(self),this.setAnimationLoop=function(b){_e=b,bt.setAnimationLoop(b),b===null?Si.stop():Si.start()},bt.addEventListener("sessionstart",vn),bt.addEventListener("sessionend",Go),this.render=function(b,X){if(X!==void 0&&X.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;if(b.matrixWorldAutoUpdate===!0&&b.updateMatrixWorld(),X.parent===null&&X.matrixWorldAutoUpdate===!0&&X.updateMatrixWorld(),bt.enabled===!0&&bt.isPresenting===!0&&(bt.cameraAutoUpdate===!0&&bt.updateCamera(X),X=bt.getCamera()),b.isScene===!0&&b.onBeforeRender(D,b,X,L),M=Lt.get(b,z.length),M.init(X),z.push(M),xt.multiplyMatrices(X.projectionMatrix,X.matrixWorldInverse),St.setFromProjectionMatrix(xt),ot=this.localClippingEnabled,W=ne.init(this.clippingPlanes,ot),R=Dt.get(b,S.length),R.init(),S.push(R),bt.enabled===!0&&bt.isPresenting===!0){const Tt=D.xr.getDepthSensingMesh();Tt!==null&&xr(Tt,X,-1/0,D.sortObjects)}xr(b,X,0,D.sortObjects),R.finish(),D.sortObjects===!0&&R.sort(Z,Mt),ee=bt.enabled===!1||bt.isPresenting===!1||bt.hasDepthSensing()===!1,ee&&Ot.addToRenderList(R,b),this.info.render.frame++,W===!0&&ne.beginShadows();const $=M.state.shadowsArray;At.render($,b,X),W===!0&&ne.endShadows(),this.info.autoReset===!0&&this.info.reset();const tt=R.opaque,Y=R.transmissive;if(M.setupLights(),X.isArrayCamera){const Tt=X.cameras;if(Y.length>0)for(let wt=0,Pt=Tt.length;wt<Pt;wt++){const Nt=Tt[wt];Mr(tt,Y,b,Nt)}ee&&Ot.render(b);for(let wt=0,Pt=Tt.length;wt<Pt;wt++){const Nt=Tt[wt];ws(R,b,Nt,Nt.viewport)}}else Y.length>0&&Mr(tt,Y,b,X),ee&&Ot.render(b),ws(R,b,X);L!==null&&($t.updateMultisampleRenderTarget(L),$t.updateRenderTargetMipmap(L)),b.isScene===!0&&b.onAfterRender(D,b,X),Zt.resetDefaultState(),j=-1,w=null,z.pop(),z.length>0?(M=z[z.length-1],W===!0&&ne.setGlobalState(D.clippingPlanes,M.state.camera)):M=null,S.pop(),S.length>0?R=S[S.length-1]:R=null};function xr(b,X,$,tt){if(b.visible===!1)return;if(b.layers.test(X.layers)){if(b.isGroup)$=b.renderOrder;else if(b.isLOD)b.autoUpdate===!0&&b.update(X);else if(b.isLight)M.pushLight(b),b.castShadow&&M.pushShadow(b);else if(b.isSprite){if(!b.frustumCulled||St.intersectsSprite(b)){tt&&Ft.setFromMatrixPosition(b.matrixWorld).applyMatrix4(xt);const wt=mt.update(b),Pt=b.material;Pt.visible&&R.push(b,wt,Pt,$,Ft.z,null)}}else if((b.isMesh||b.isLine||b.isPoints)&&(!b.frustumCulled||St.intersectsObject(b))){const wt=mt.update(b),Pt=b.material;if(tt&&(b.boundingSphere!==void 0?(b.boundingSphere===null&&b.computeBoundingSphere(),Ft.copy(b.boundingSphere.center)):(wt.boundingSphere===null&&wt.computeBoundingSphere(),Ft.copy(wt.boundingSphere.center)),Ft.applyMatrix4(b.matrixWorld).applyMatrix4(xt)),Array.isArray(Pt)){const Nt=wt.groups;for(let zt=0,Qt=Nt.length;zt<Qt;zt++){const Gt=Nt[zt],le=Pt[Gt.materialIndex];le&&le.visible&&R.push(b,wt,le,$,Ft.z,Gt)}}else Pt.visible&&R.push(b,wt,Pt,$,Ft.z,null)}}const Tt=b.children;for(let wt=0,Pt=Tt.length;wt<Pt;wt++)xr(Tt[wt],X,$,tt)}function ws(b,X,$,tt){const Y=b.opaque,Tt=b.transmissive,wt=b.transparent;M.setupLightsView($),W===!0&&ne.setGlobalState(D.clippingPlanes,$),tt&&Vt.viewport(C.copy(tt)),Y.length>0&&aa(Y,X,$),Tt.length>0&&aa(Tt,X,$),wt.length>0&&aa(wt,X,$),Vt.buffers.depth.setTest(!0),Vt.buffers.depth.setMask(!0),Vt.buffers.color.setMask(!0),Vt.setPolygonOffset(!1)}function Mr(b,X,$,tt){if(($.isScene===!0?$.overrideMaterial:null)!==null)return;M.state.transmissionRenderTarget[tt.id]===void 0&&(M.state.transmissionRenderTarget[tt.id]=new Sr(1,1,{generateMipmaps:!0,type:ue.has("EXT_color_buffer_half_float")||ue.has("EXT_color_buffer_float")?Oo:ta,minFilter:gr,samples:4,stencilBuffer:c,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Te.workingColorSpace}));const Tt=M.state.transmissionRenderTarget[tt.id],wt=tt.viewport||C;Tt.setSize(wt.z,wt.w);const Pt=D.getRenderTarget();D.setRenderTarget(Tt),D.getClearColor(at),ct=D.getClearAlpha(),ct<1&&D.setClearColor(16777215,.5),D.clear(),ee&&Ot.render($);const Nt=D.toneMapping;D.toneMapping=Ia;const zt=tt.viewport;if(tt.viewport!==void 0&&(tt.viewport=void 0),M.setupLightsView(tt),W===!0&&ne.setGlobalState(D.clippingPlanes,tt),aa(b,$,tt),$t.updateMultisampleRenderTarget(Tt),$t.updateRenderTargetMipmap(Tt),ue.has("WEBGL_multisampled_render_to_texture")===!1){let Qt=!1;for(let Gt=0,le=X.length;Gt<le;Gt++){const be=X[Gt],Fe=be.object,xn=be.geometry,ve=be.material,Xt=be.group;if(ve.side===Qi&&Fe.layers.test(tt.layers)){const ke=ve.side;ve.side=Bn,ve.needsUpdate=!0,Ds(Fe,$,tt,xn,ve,Xt),ve.side=ke,ve.needsUpdate=!0,Qt=!0}}Qt===!0&&($t.updateMultisampleRenderTarget(Tt),$t.updateRenderTargetMipmap(Tt))}D.setRenderTarget(Pt),D.setClearColor(at,ct),zt!==void 0&&(tt.viewport=zt),D.toneMapping=Nt}function aa(b,X,$){const tt=X.isScene===!0?X.overrideMaterial:null;for(let Y=0,Tt=b.length;Y<Tt;Y++){const wt=b[Y],Pt=wt.object,Nt=wt.geometry,zt=tt===null?wt.material:tt,Qt=wt.group;Pt.layers.test($.layers)&&Ds(Pt,X,$,Nt,zt,Qt)}}function Ds(b,X,$,tt,Y,Tt){b.onBeforeRender(D,X,$,tt,Y,Tt),b.modelViewMatrix.multiplyMatrices($.matrixWorldInverse,b.matrixWorld),b.normalMatrix.getNormalMatrix(b.modelViewMatrix),Y.onBeforeRender(D,X,$,tt,b,Tt),Y.transparent===!0&&Y.side===Qi&&Y.forceSinglePass===!1?(Y.side=Bn,Y.needsUpdate=!0,D.renderBufferDirect($,X,tt,Y,b,Tt),Y.side=Fa,Y.needsUpdate=!0,D.renderBufferDirect($,X,tt,Y,b,Tt),Y.side=Qi):D.renderBufferDirect($,X,tt,Y,b,Tt),b.onAfterRender(D,X,$,tt,Y,Tt)}function Ga(b,X,$){X.isScene!==!0&&(X=It);const tt=Jt.get(b),Y=M.state.lights,Tt=M.state.shadowsArray,wt=Y.state.version,Pt=vt.getParameters(b,Y.state,Tt,X,$),Nt=vt.getProgramCacheKey(Pt);let zt=tt.programs;tt.environment=b.isMeshStandardMaterial?X.environment:null,tt.fog=X.fog,tt.envMap=(b.isMeshStandardMaterial?T:N).get(b.envMap||tt.environment),tt.envMapRotation=tt.environment!==null&&b.envMap===null?X.environmentRotation:b.envMapRotation,zt===void 0&&(b.addEventListener("dispose",kt),zt=new Map,tt.programs=zt);let Qt=zt.get(Nt);if(Qt!==void 0){if(tt.currentProgram===Qt&&tt.lightsStateVersion===wt)return Ke(b,Pt),Qt}else Pt.uniforms=vt.getUniforms(b),b.onBeforeCompile(Pt,D),Qt=vt.acquireProgram(Pt,Nt),zt.set(Nt,Qt),tt.uniforms=Pt.uniforms;const Gt=tt.uniforms;return(!b.isShaderMaterial&&!b.isRawShaderMaterial||b.clipping===!0)&&(Gt.clippingPlanes=ne.uniform),Ke(b,Pt),tt.needsLights=Us(b),tt.lightsStateVersion=wt,tt.needsLights&&(Gt.ambientLightColor.value=Y.state.ambient,Gt.lightProbe.value=Y.state.probe,Gt.directionalLights.value=Y.state.directional,Gt.directionalLightShadows.value=Y.state.directionalShadow,Gt.spotLights.value=Y.state.spot,Gt.spotLightShadows.value=Y.state.spotShadow,Gt.rectAreaLights.value=Y.state.rectArea,Gt.ltc_1.value=Y.state.rectAreaLTC1,Gt.ltc_2.value=Y.state.rectAreaLTC2,Gt.pointLights.value=Y.state.point,Gt.pointLightShadows.value=Y.state.pointShadow,Gt.hemisphereLights.value=Y.state.hemi,Gt.directionalShadowMap.value=Y.state.directionalShadowMap,Gt.directionalShadowMatrix.value=Y.state.directionalShadowMatrix,Gt.spotShadowMap.value=Y.state.spotShadowMap,Gt.spotLightMatrix.value=Y.state.spotLightMatrix,Gt.spotLightMap.value=Y.state.spotLightMap,Gt.pointShadowMap.value=Y.state.pointShadowMap,Gt.pointShadowMatrix.value=Y.state.pointShadowMatrix),tt.currentProgram=Qt,tt.uniformsList=null,Qt}function oi(b){if(b.uniformsList===null){const X=b.currentProgram.getUniforms();b.uniformsList=Ru.seqWithValue(X.seq,b.uniforms)}return b.uniformsList}function Ke(b,X){const $=Jt.get(b);$.outputColorSpace=X.outputColorSpace,$.batching=X.batching,$.batchingColor=X.batchingColor,$.instancing=X.instancing,$.instancingColor=X.instancingColor,$.instancingMorph=X.instancingMorph,$.skinning=X.skinning,$.morphTargets=X.morphTargets,$.morphNormals=X.morphNormals,$.morphColors=X.morphColors,$.morphTargetsCount=X.morphTargetsCount,$.numClippingPlanes=X.numClippingPlanes,$.numIntersection=X.numClipIntersection,$.vertexAlphas=X.vertexAlphas,$.vertexTangents=X.vertexTangents,$.toneMapping=X.toneMapping}function Sn(b,X,$,tt,Y){X.isScene!==!0&&(X=It),$t.resetTextureUnits();const Tt=X.fog,wt=tt.isMeshStandardMaterial?X.environment:null,Pt=L===null?D.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:Ha,Nt=(tt.isMeshStandardMaterial?T:N).get(tt.envMap||wt),zt=tt.vertexColors===!0&&!!$.attributes.color&&$.attributes.color.itemSize===4,Qt=!!$.attributes.tangent&&(!!tt.normalMap||tt.anisotropy>0),Gt=!!$.morphAttributes.position,le=!!$.morphAttributes.normal,be=!!$.morphAttributes.color;let Fe=Ia;tt.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(Fe=D.toneMapping);const xn=$.morphAttributes.position||$.morphAttributes.normal||$.morphAttributes.color,ve=xn!==void 0?xn.length:0,Xt=Jt.get(tt),ke=M.state.lights;if(W===!0&&(ot===!0||b!==w)){const Cn=b===w&&tt.id===j;ne.setState(tt,b,Cn)}let me=!1;tt.version===Xt.__version?(Xt.needsLights&&Xt.lightsStateVersion!==ke.state.version||Xt.outputColorSpace!==Pt||Y.isBatchedMesh&&Xt.batching===!1||!Y.isBatchedMesh&&Xt.batching===!0||Y.isBatchedMesh&&Xt.batchingColor===!0&&Y.colorTexture===null||Y.isBatchedMesh&&Xt.batchingColor===!1&&Y.colorTexture!==null||Y.isInstancedMesh&&Xt.instancing===!1||!Y.isInstancedMesh&&Xt.instancing===!0||Y.isSkinnedMesh&&Xt.skinning===!1||!Y.isSkinnedMesh&&Xt.skinning===!0||Y.isInstancedMesh&&Xt.instancingColor===!0&&Y.instanceColor===null||Y.isInstancedMesh&&Xt.instancingColor===!1&&Y.instanceColor!==null||Y.isInstancedMesh&&Xt.instancingMorph===!0&&Y.morphTexture===null||Y.isInstancedMesh&&Xt.instancingMorph===!1&&Y.morphTexture!==null||Xt.envMap!==Nt||tt.fog===!0&&Xt.fog!==Tt||Xt.numClippingPlanes!==void 0&&(Xt.numClippingPlanes!==ne.numPlanes||Xt.numIntersection!==ne.numIntersection)||Xt.vertexAlphas!==zt||Xt.vertexTangents!==Qt||Xt.morphTargets!==Gt||Xt.morphNormals!==le||Xt.morphColors!==be||Xt.toneMapping!==Fe||Xt.morphTargetsCount!==ve)&&(me=!0):(me=!0,Xt.__version=tt.version);let Ye=Xt.currentProgram;me===!0&&(Ye=Ga(tt,X,Y));let on=!1,Mn=!1,Ls=!1;const He=Ye.getUniforms(),li=Xt.uniforms;if(Vt.useProgram(Ye.program)&&(on=!0,Mn=!0,Ls=!0),tt.id!==j&&(j=tt.id,Mn=!0),on||w!==b){He.setValue(I,"projectionMatrix",b.projectionMatrix),He.setValue(I,"viewMatrix",b.matrixWorldInverse);const Cn=He.map.cameraPosition;Cn!==void 0&&Cn.setValue(I,yt.setFromMatrixPosition(b.matrixWorld)),Se.logarithmicDepthBuffer&&He.setValue(I,"logDepthBufFC",2/(Math.log(b.far+1)/Math.LN2)),(tt.isMeshPhongMaterial||tt.isMeshToonMaterial||tt.isMeshLambertMaterial||tt.isMeshBasicMaterial||tt.isMeshStandardMaterial||tt.isShaderMaterial)&&He.setValue(I,"isOrthographic",b.isOrthographicCamera===!0),w!==b&&(w=b,Mn=!0,Ls=!0)}if(Y.isSkinnedMesh){He.setOptional(I,Y,"bindMatrix"),He.setOptional(I,Y,"bindMatrixInverse");const Cn=Y.skeleton;Cn&&(Cn.boneTexture===null&&Cn.computeBoneTexture(),He.setValue(I,"boneTexture",Cn.boneTexture,$t))}Y.isBatchedMesh&&(He.setOptional(I,Y,"batchingTexture"),He.setValue(I,"batchingTexture",Y._matricesTexture,$t),He.setOptional(I,Y,"batchingIdTexture"),He.setValue(I,"batchingIdTexture",Y._indirectTexture,$t),He.setOptional(I,Y,"batchingColorTexture"),Y._colorsTexture!==null&&He.setValue(I,"batchingColorTexture",Y._colorsTexture,$t));const sa=$.morphAttributes;if((sa.position!==void 0||sa.normal!==void 0||sa.color!==void 0)&&he.update(Y,$,Ye),(Mn||Xt.receiveShadow!==Y.receiveShadow)&&(Xt.receiveShadow=Y.receiveShadow,He.setValue(I,"receiveShadow",Y.receiveShadow)),tt.isMeshGouraudMaterial&&tt.envMap!==null&&(li.envMap.value=Nt,li.flipEnvMap.value=Nt.isCubeTexture&&Nt.isRenderTargetTexture===!1?-1:1),tt.isMeshStandardMaterial&&tt.envMap===null&&X.environment!==null&&(li.envMapIntensity.value=X.environmentIntensity),Mn&&(He.setValue(I,"toneMappingExposure",D.toneMappingExposure),Xt.needsLights&&ra(li,Ls),Tt&&tt.fog===!0&&Wt.refreshFogUniforms(li,Tt),Wt.refreshMaterialUniforms(li,tt,q,O,M.state.transmissionRenderTarget[b.id]),Ru.upload(I,oi(Xt),li,$t)),tt.isShaderMaterial&&tt.uniformsNeedUpdate===!0&&(Ru.upload(I,oi(Xt),li,$t),tt.uniformsNeedUpdate=!1),tt.isSpriteMaterial&&He.setValue(I,"center",Y.center),He.setValue(I,"modelViewMatrix",Y.modelViewMatrix),He.setValue(I,"normalMatrix",Y.normalMatrix),He.setValue(I,"modelMatrix",Y.matrixWorld),tt.isShaderMaterial||tt.isRawShaderMaterial){const Cn=tt.uniformsGroups;for(let yn=0,Ns=Cn.length;yn<Ns;yn++){const Os=Cn[yn];Pe.update(Os,Ye),Pe.bind(Os,Ye)}}return Ye}function ra(b,X){b.ambientLightColor.needsUpdate=X,b.lightProbe.needsUpdate=X,b.directionalLights.needsUpdate=X,b.directionalLightShadows.needsUpdate=X,b.pointLights.needsUpdate=X,b.pointLightShadows.needsUpdate=X,b.spotLights.needsUpdate=X,b.spotLightShadows.needsUpdate=X,b.rectAreaLights.needsUpdate=X,b.hemisphereLights.needsUpdate=X}function Us(b){return b.isMeshLambertMaterial||b.isMeshToonMaterial||b.isMeshPhongMaterial||b.isMeshStandardMaterial||b.isShadowMaterial||b.isShaderMaterial&&b.lights===!0}this.getActiveCubeFace=function(){return et},this.getActiveMipmapLevel=function(){return F},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(b,X,$){Jt.get(b.texture).__webglTexture=X,Jt.get(b.depthTexture).__webglTexture=$;const tt=Jt.get(b);tt.__hasExternalTextures=!0,tt.__autoAllocateDepthBuffer=$===void 0,tt.__autoAllocateDepthBuffer||ue.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),tt.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(b,X){const $=Jt.get(b);$.__webglFramebuffer=X,$.__useDefaultFramebuffer=X===void 0},this.setRenderTarget=function(b,X=0,$=0){L=b,et=X,F=$;let tt=!0,Y=null,Tt=!1,wt=!1;if(b){const Nt=Jt.get(b);if(Nt.__useDefaultFramebuffer!==void 0)Vt.bindFramebuffer(I.FRAMEBUFFER,null),tt=!1;else if(Nt.__webglFramebuffer===void 0)$t.setupRenderTarget(b);else if(Nt.__hasExternalTextures)$t.rebindTextures(b,Jt.get(b.texture).__webglTexture,Jt.get(b.depthTexture).__webglTexture);else if(b.depthBuffer){const Gt=b.depthTexture;if(Nt.__boundDepthTexture!==Gt){if(Gt!==null&&Jt.has(Gt)&&(b.width!==Gt.image.width||b.height!==Gt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");$t.setupDepthRenderbuffer(b)}}const zt=b.texture;(zt.isData3DTexture||zt.isDataArrayTexture||zt.isCompressedArrayTexture)&&(wt=!0);const Qt=Jt.get(b).__webglFramebuffer;b.isWebGLCubeRenderTarget?(Array.isArray(Qt[X])?Y=Qt[X][$]:Y=Qt[X],Tt=!0):b.samples>0&&$t.useMultisampledRTT(b)===!1?Y=Jt.get(b).__webglMultisampledFramebuffer:Array.isArray(Qt)?Y=Qt[$]:Y=Qt,C.copy(b.viewport),G.copy(b.scissor),lt=b.scissorTest}else C.copy(Et).multiplyScalar(q).floor(),G.copy(U).multiplyScalar(q).floor(),lt=nt;if(Vt.bindFramebuffer(I.FRAMEBUFFER,Y)&&tt&&Vt.drawBuffers(b,Y),Vt.viewport(C),Vt.scissor(G),Vt.setScissorTest(lt),Tt){const Nt=Jt.get(b.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+X,Nt.__webglTexture,$)}else if(wt){const Nt=Jt.get(b.texture),zt=X||0;I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,Nt.__webglTexture,$||0,zt)}j=-1},this.readRenderTargetPixels=function(b,X,$,tt,Y,Tt,wt){if(!(b&&b.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Pt=Jt.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&wt!==void 0&&(Pt=Pt[wt]),Pt){Vt.bindFramebuffer(I.FRAMEBUFFER,Pt);try{const Nt=b.texture,zt=Nt.format,Qt=Nt.type;if(!Se.textureFormatReadable(zt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Se.textureTypeReadable(Qt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}X>=0&&X<=b.width-tt&&$>=0&&$<=b.height-Y&&I.readPixels(X,$,tt,Y,Yt.convert(zt),Yt.convert(Qt),Tt)}finally{const Nt=L!==null?Jt.get(L).__webglFramebuffer:null;Vt.bindFramebuffer(I.FRAMEBUFFER,Nt)}}},this.readRenderTargetPixelsAsync=async function(b,X,$,tt,Y,Tt,wt){if(!(b&&b.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Pt=Jt.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&wt!==void 0&&(Pt=Pt[wt]),Pt){Vt.bindFramebuffer(I.FRAMEBUFFER,Pt);try{const Nt=b.texture,zt=Nt.format,Qt=Nt.type;if(!Se.textureFormatReadable(zt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Se.textureTypeReadable(Qt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(X>=0&&X<=b.width-tt&&$>=0&&$<=b.height-Y){const Gt=I.createBuffer();I.bindBuffer(I.PIXEL_PACK_BUFFER,Gt),I.bufferData(I.PIXEL_PACK_BUFFER,Tt.byteLength,I.STREAM_READ),I.readPixels(X,$,tt,Y,Yt.convert(zt),Yt.convert(Qt),0),I.flush();const le=I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE,0);await iM(I,le,4);try{I.bindBuffer(I.PIXEL_PACK_BUFFER,Gt),I.getBufferSubData(I.PIXEL_PACK_BUFFER,0,Tt)}finally{I.deleteBuffer(Gt),I.deleteSync(le)}return Tt}}finally{const Nt=L!==null?Jt.get(L).__webglFramebuffer:null;Vt.bindFramebuffer(I.FRAMEBUFFER,Nt)}}},this.copyFramebufferToTexture=function(b,X=null,$=0){b.isTexture!==!0&&(Lo("WebGLRenderer: copyFramebufferToTexture function signature has changed."),X=arguments[0]||null,b=arguments[1]);const tt=Math.pow(2,-$),Y=Math.floor(b.image.width*tt),Tt=Math.floor(b.image.height*tt),wt=X!==null?X.x:0,Pt=X!==null?X.y:0;$t.setTexture2D(b,0),I.copyTexSubImage2D(I.TEXTURE_2D,$,0,0,wt,Pt,Y,Tt),Vt.unbindTexture()},this.copyTextureToTexture=function(b,X,$=null,tt=null,Y=0){b.isTexture!==!0&&(Lo("WebGLRenderer: copyTextureToTexture function signature has changed."),tt=arguments[0]||null,b=arguments[1],X=arguments[2],Y=arguments[3]||0,$=null);let Tt,wt,Pt,Nt,zt,Qt;$!==null?(Tt=$.max.x-$.min.x,wt=$.max.y-$.min.y,Pt=$.min.x,Nt=$.min.y):(Tt=b.image.width,wt=b.image.height,Pt=0,Nt=0),tt!==null?(zt=tt.x,Qt=tt.y):(zt=0,Qt=0);const Gt=Yt.convert(X.format),le=Yt.convert(X.type);$t.setTexture2D(X,0),I.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,X.flipY),I.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,X.premultiplyAlpha),I.pixelStorei(I.UNPACK_ALIGNMENT,X.unpackAlignment);const be=I.getParameter(I.UNPACK_ROW_LENGTH),Fe=I.getParameter(I.UNPACK_IMAGE_HEIGHT),xn=I.getParameter(I.UNPACK_SKIP_PIXELS),ve=I.getParameter(I.UNPACK_SKIP_ROWS),Xt=I.getParameter(I.UNPACK_SKIP_IMAGES),ke=b.isCompressedTexture?b.mipmaps[Y]:b.image;I.pixelStorei(I.UNPACK_ROW_LENGTH,ke.width),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,ke.height),I.pixelStorei(I.UNPACK_SKIP_PIXELS,Pt),I.pixelStorei(I.UNPACK_SKIP_ROWS,Nt),b.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,Y,zt,Qt,Tt,wt,Gt,le,ke.data):b.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,Y,zt,Qt,ke.width,ke.height,Gt,ke.data):I.texSubImage2D(I.TEXTURE_2D,Y,zt,Qt,Tt,wt,Gt,le,ke),I.pixelStorei(I.UNPACK_ROW_LENGTH,be),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,Fe),I.pixelStorei(I.UNPACK_SKIP_PIXELS,xn),I.pixelStorei(I.UNPACK_SKIP_ROWS,ve),I.pixelStorei(I.UNPACK_SKIP_IMAGES,Xt),Y===0&&X.generateMipmaps&&I.generateMipmap(I.TEXTURE_2D),Vt.unbindTexture()},this.copyTextureToTexture3D=function(b,X,$=null,tt=null,Y=0){b.isTexture!==!0&&(Lo("WebGLRenderer: copyTextureToTexture3D function signature has changed."),$=arguments[0]||null,tt=arguments[1]||null,b=arguments[2],X=arguments[3],Y=arguments[4]||0);let Tt,wt,Pt,Nt,zt,Qt,Gt,le,be;const Fe=b.isCompressedTexture?b.mipmaps[Y]:b.image;$!==null?(Tt=$.max.x-$.min.x,wt=$.max.y-$.min.y,Pt=$.max.z-$.min.z,Nt=$.min.x,zt=$.min.y,Qt=$.min.z):(Tt=Fe.width,wt=Fe.height,Pt=Fe.depth,Nt=0,zt=0,Qt=0),tt!==null?(Gt=tt.x,le=tt.y,be=tt.z):(Gt=0,le=0,be=0);const xn=Yt.convert(X.format),ve=Yt.convert(X.type);let Xt;if(X.isData3DTexture)$t.setTexture3D(X,0),Xt=I.TEXTURE_3D;else if(X.isDataArrayTexture||X.isCompressedArrayTexture)$t.setTexture2DArray(X,0),Xt=I.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}I.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,X.flipY),I.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,X.premultiplyAlpha),I.pixelStorei(I.UNPACK_ALIGNMENT,X.unpackAlignment);const ke=I.getParameter(I.UNPACK_ROW_LENGTH),me=I.getParameter(I.UNPACK_IMAGE_HEIGHT),Ye=I.getParameter(I.UNPACK_SKIP_PIXELS),on=I.getParameter(I.UNPACK_SKIP_ROWS),Mn=I.getParameter(I.UNPACK_SKIP_IMAGES);I.pixelStorei(I.UNPACK_ROW_LENGTH,Fe.width),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,Fe.height),I.pixelStorei(I.UNPACK_SKIP_PIXELS,Nt),I.pixelStorei(I.UNPACK_SKIP_ROWS,zt),I.pixelStorei(I.UNPACK_SKIP_IMAGES,Qt),b.isDataTexture||b.isData3DTexture?I.texSubImage3D(Xt,Y,Gt,le,be,Tt,wt,Pt,xn,ve,Fe.data):X.isCompressedArrayTexture?I.compressedTexSubImage3D(Xt,Y,Gt,le,be,Tt,wt,Pt,xn,Fe.data):I.texSubImage3D(Xt,Y,Gt,le,be,Tt,wt,Pt,xn,ve,Fe),I.pixelStorei(I.UNPACK_ROW_LENGTH,ke),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,me),I.pixelStorei(I.UNPACK_SKIP_PIXELS,Ye),I.pixelStorei(I.UNPACK_SKIP_ROWS,on),I.pixelStorei(I.UNPACK_SKIP_IMAGES,Mn),Y===0&&X.generateMipmaps&&I.generateMipmap(Xt),Vt.unbindTexture()},this.initRenderTarget=function(b){Jt.get(b).__webglFramebuffer===void 0&&$t.setupRenderTarget(b)},this.initTexture=function(b){b.isCubeTexture?$t.setTextureCube(b,0):b.isData3DTexture?$t.setTexture3D(b,0):b.isDataArrayTexture||b.isCompressedArrayTexture?$t.setTexture2DArray(b,0):$t.setTexture2D(b,0),Vt.unbindTexture()},this.resetState=function(){et=0,F=0,L=null,Vt.reset(),Zt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return $i}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const i=this.getContext();i.drawingBufferColorSpace=e===md?"display-p3":"srgb",i.unpackColorSpace=Te.workingColorSpace===zu?"display-p3":"srgb"}}class db extends Fn{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new ea,this.environmentIntensity=1,this.environmentRotation=new ea,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,i){return super.copy(e,i),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const i=super.toJSON(e);return this.fog!==null&&(i.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(i.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(i.object.backgroundIntensity=this.backgroundIntensity),i.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(i.object.environmentIntensity=this.environmentIntensity),i.object.environmentRotation=this.environmentRotation.toArray(),i}}class k0 extends Io{constructor(e){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new Ae(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const a0=new rn,sd=new R0,xu=new Bu,Mu=new it;class pb extends Fn{constructor(e=new ia,i=new k0){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=i,this.updateMorphTargets()}copy(e,i){return super.copy(e,i),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,i){const r=this.geometry,l=this.matrixWorld,c=e.params.Points.threshold,h=r.drawRange;if(r.boundingSphere===null&&r.computeBoundingSphere(),xu.copy(r.boundingSphere),xu.applyMatrix4(l),xu.radius+=c,e.ray.intersectsSphere(xu)===!1)return;a0.copy(l).invert(),sd.copy(e.ray).applyMatrix4(a0);const d=c/((this.scale.x+this.scale.y+this.scale.z)/3),m=d*d,p=r.index,v=r.attributes.position;if(p!==null){const x=Math.max(0,h.start),y=Math.min(p.count,h.start+h.count);for(let A=x,R=y;A<R;A++){const M=p.getX(A);Mu.fromBufferAttribute(v,M),r0(Mu,M,m,l,e,i,this)}}else{const x=Math.max(0,h.start),y=Math.min(v.count,h.start+h.count);for(let A=x,R=y;A<R;A++)Mu.fromBufferAttribute(v,A),r0(Mu,A,m,l,e,i,this)}}updateMorphTargets(){const i=this.geometry.morphAttributes,r=Object.keys(i);if(r.length>0){const l=i[r[0]];if(l!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let c=0,h=l.length;c<h;c++){const d=l[c].name||String(c);this.morphTargetInfluences.push(0),this.morphTargetDictionary[d]=c}}}}}function r0(o,e,i,r,l,c,h){const d=sd.distanceSqToPoint(o);if(d<i){const m=new it;sd.closestPointToPoint(o,m),m.applyMatrix4(r);const p=l.ray.origin.distanceTo(m);if(p<l.near||p>l.far)return;c.push({distance:p,distanceToRay:Math.sqrt(d),point:m,index:e,face:null,object:h})}}class mb{constructor(e=!0){this.autoStart=e,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=s0(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let e=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const i=s0();e=(i-this.oldTime)/1e3,this.oldTime=i,this.elapsedTime+=e}return e}}function s0(){return(typeof performance>"u"?Date:performance).now()}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:ld}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=ld);const Kn=[3552,3648,4215,4346,4702,4973,5454,6078,6080,6205,6373,6845,7570,7601,7602,8158,8739,8781,9129,9333,9410,9707,10027,10182,10630,11093,11379,11631,11744,12808,13462,13595,13632,13663,14628,14831,15796,15972,17245,17656,17846,19187,19592,19839,19901,20621,21214,21278,22706,24426,27871,28063,28531,29246,32530,35966,43822],hr=[.20320023,.240428955,.250814845,.27683691,.291074667,.3021083,.311718809,.324788147,.347799353,.362536656,.400185582,.417333031,.426267343,.437478346,.463457391,.470897362,.485592675,.533439258,.547034522,.557377309,.565667836,.576007618,.583099392,.589947027,.601855424,.644230419,.650078677,.658507585,.664425149,.691539883,.700260709,.728996858,.733857774,.753453022,.778192209,.782484904,.794440567,.808868488,.811877735,.8155771,.832775062,.854179756,.857698942,.86473999,.875209863,.88001511,.882261864,.899455841,.923902348,.93460629,.942972185,.955804172,.963306037,.97078122,.975832842,.987263722,.995676395];function o0(o){const e=Kn.length,i=Kn[0],r=hr[0],l=Kn[e-1],c=hr[e-1];if(o<i){const v=i/3;return o<=0?0:r*(Math.exp(o/v)-1)/(Math.exp(i/v)-1)}if(o>l){const v=(hr[e-1]-hr[e-2])/(Kn[e-1]-Kn[e-2]),x=v<=0?1:(1-c)/v;return 1-(1-c)*Math.exp(-(o-l)/x)}let h=0;for(;h<e-1&&Kn[h+1]<=o;)h+=1;const d=Kn[h],m=Kn[h+1],p=hr[h],_=hr[h+1];return p+(_-p)*(o-d)/(m-d)}const Ah=35966,gb=43822,l0=[{min:90,src:"images/5090.png",label:"5090"},{min:70,src:"images/5060.png",label:"5060"},{min:50,src:"images/5060baby.png",label:"5060 Baby"},{min:30,src:"images/dinkyboi.png",label:"Dinky Boi"},{min:0,src:"images/sd.png",label:"SD"}];function _b(o,e){const[i,r]=an.useState(o),l=an.useRef(i);return an.useEffect(()=>{l.current=i},[i]),an.useEffect(()=>{let c;const h=l.current,d=650,m=performance.now(),p=_=>{const v=Math.min((_-m)/d,1),x=1-Math.pow(1-v,3);r(h+(o-h)*x),v<1&&(c=requestAnimationFrame(p))};return c=requestAnimationFrame(p),()=>cancelAnimationFrame(c)},[o,e]),i}function vb(o){return o>=.99?"Top 1%":o>=.95?"Top 5%":o>=.9?"Top 10%":o>=.8?"Top 20%":o>=.7?"Top 30%":o>=.5?"Above Average":o>=.3?"Mid Pack":"Entry Tier"}function u0(o){const e=Math.max(0,Math.min(100,o));return l0.find(i=>e>=i.min)??l0.at(-1)}function Sb(o){if(!Kn.length)return null;let e=0,i=Math.abs(o-Kn[0]);for(let r=1;r<Kn.length;r+=1){const l=Math.abs(o-Kn[r]);l<i&&(i=l,e=r)}return{score:Kn[e],pct:hr[e]}}function xb({auraPower:o,onWebglFail:e}){const i=an.useRef(null),r=an.useRef(o);return an.useEffect(()=>{r.current=o},[o]),an.useEffect(()=>{const l=i.current;if(!l)return;let c;try{c=new hb({alpha:!0,antialias:!0,powerPreference:"high-performance"})}catch{e?.();return}if(!c.getContext()){e?.();return}const d=new db,m=new I0(-1,1,1,-1,0,1);l.appendChild(c.domElement);const p={time:{value:0},auraPower:{value:r.current},resolution:{value:new Ee(1,1)}},_=new na({uniforms:p,transparent:!0,blending:Cu,vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = vec4(position, 1.0);
      ...
      `,fragmentShader:`
        ...
        void main() {
          ...
          float intensity = 0.8 + logPower * 0.55;
          float pulse = 0.55 + 0.45 * sin(time * (1.1 + logPower * 0.35));
          vec3 baseColor = mix(vec3(0.25, 0.6, 1.0), vec3(1.0, 0.8, 0.3), clamp(logPower / 6.0, 0.0, 1.0));
          vec3 color = baseColor * glow * intensity * pulse + vec3(1.4, 1.05, 0.7) * lightning;
          float alpha = clamp(glow * 1.8 + lightning, 0.0, 1.0);
          gl_FragColor = vec4(color, alpha);
        }
      `}),v=new Ri(new Ho(2,2),_);d.add(v);const x=4600,y=900,A=new Float32Array(x*3),R=new Float32Array(x*3);for(let L=0;L<x;L+=1){const j=L*3;A[j]=(Math.random()*2-1)*.9,A[j+1]=(Math.random()*2-1)*.9,A[j+2]=Math.random()*.5,R[j]=(Math.random()*2-1)*.12,R[j+1]=.2+Math.random()*.5,R[j+2]=0}const M=new ia;M.setAttribute("position",new vi(A,3));const S=new k0({color:new Ae(1,.85,.5),size:.02,transparent:!0,opacity:.65,blending:Cu,depthWrite:!1}),z=new pb(M,S);d.add(z);const D=()=>{const{clientWidth:L,clientHeight:j}=l;c.setSize(L,j),c.setPixelRatio(Math.min(window.devicePixelRatio,2)),p.resolution.value.set(L,j)};D(),window.addEventListener("resize",D);const P=new mb,et=()=>{const L=P.getElapsedTime();p.time.value=L,p.auraPower.value=r.current;const j=Math.max(r.current,0),w=Math.log1p(j),C=Math.min(x,y+Math.floor(j*520));M.setDrawRange(0,C);const G=.8+w*.2,lt=.55+w*.18;S.opacity=Math.min(.98,lt),S.size=Math.min(.08,.016+w*.008),S.color.setHSL(.12,.95,Math.min(.75,.45+w*.09));for(let at=0;at<x;at+=1){const ct=at*3;A[ct]+=R[ct]*G*.02,A[ct+1]+=R[ct+1]*G*.02,A[ct+1]>1.1&&(A[ct+1]=-1.1,A[ct]=(Math.random()*2-1)*.95),(A[ct]>1.1||A[ct]<-1.1)&&(A[ct]=(Math.random()*2-1)*.95)}M.attributes.position.needsUpdate=!0,c.render(d,m),F=requestAnimationFrame(et)};let F=requestAnimationFrame(et);return()=>{cancelAnimationFrame(F),window.removeEventListener("resize",D),M.dispose(),S.dispose(),_.dispose(),c.dispose(),c.domElement.parentElement&&c.domElement.parentElement.removeChild(c.domElement)}},[e]),nn.jsx("div",{className:"aura-canvas",ref:i})}function Mb(){const[o,e]=an.useState(!0),[i,r]=an.useState(!1),[l,c]=an.useState(String(Ah)),[h,d]=an.useState(Ah),[m,p]=an.useState(""),_="./",[v,x]=an.useState(()=>`${_}${u0(o0(Ah)*100).src}`),[y,A]=an.useState(null),[R,M]=an.useState(!1),S=an.useMemo(()=>{const w=o0(h);return Number.isNaN(w)?0:Math.max(0,Math.min(1,w))},[h]),z=S*100,D=_b(z,!0),P=vb(S),et=an.useMemo(()=>Sb(h),[h]),F=Math.pow(Math.max(h/gb,0),1.8);an.useEffect(()=>{const w=u0(z),C=`${_}${w.src}`;if(C===v)return;A(v),x(C),M(!0);const G=setTimeout(()=>{M(!1),A(null)},600);return()=>clearTimeout(G)},[v,z]);const L=w=>{const C=w.target.value;if(c(C),!C){p("");return}/^\d+$/.test(C)?(p(""),d(Number(C))):p("Score must be a non-negative integer.")},j=()=>{const w=l.trim();if(!w){p("Enter a score to calculate.");return}if(!/^\d+$/.test(w)){p("Score must be a non-negative integer.");return}d(Number(w)),p(""),r(!1)};return nn.jsxs("div",{className:"page",children:[nn.jsx("div",{className:"aura-layer","aria-hidden":"true",children:o?nn.jsx(xb,{auraPower:F,onWebglFail:()=>e(!1)}):nn.jsx("div",{className:"aura-fallback"})}),nn.jsxs("main",{className:"content",children:[nn.jsxs("div",{className:"output score-layer",children:[i?nn.jsx("input",{className:"score-inline",type:"text",inputMode:"numeric",pattern:"[0-9]*",value:l,onChange:L,onBlur:j,onKeyDown:w=>{w.key==="Enter"&&(w.preventDefault(),j()),w.key==="Escape"&&(r(!1),p(""),c(String(h)))},"aria-label":"3DMark score",autoFocus:!0}):nn.jsxs("button",{type:"button",className:"output-value output-button",onClick:()=>r(!0),children:[D.toFixed(2),"%"]}),nn.jsx("p",{className:"output-tag",children:P}),m?nn.jsx("p",{className:"error",children:m}):null,et?nn.jsxs("p",{className:"calibration",children:["Nearest calibration: ",et.score," →"," ",(et.pct*100).toFixed(2),"%"]}):null]}),nn.jsx("section",{className:"card gpu-layer",children:nn.jsxs("div",{className:`card-art ${R?"is-fading":""}`,children:[y?nn.jsx("img",{className:"card-img prev",src:y,alt:"Previous GPU card art"}):null,nn.jsx("img",{className:"card-img current",src:v,alt:"GPU card art"}),nn.jsx("div",{className:"card-glow","aria-hidden":"true"})]})}),!o&&nn.jsx("div",{className:"toggle-note",children:"WebGL unavailable"})]})]})}rx.createRoot(document.getElementById("root")).render(nn.jsx(an.StrictMode,{children:nn.jsx(Mb,{})}));
