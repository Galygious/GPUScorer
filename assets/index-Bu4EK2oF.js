	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            void main() {
              ...
              float edge = smoothstep(1.0, 2.3, dist0);
              ...
              float heightFade = smoothstep(-1.0, 5.5, advectedPos.y) * smoothstep(6.5, 4.0, advectedPos.y);
              vAlpha = smoothstep(2.5, 0.5, distFromCenter) * pulse * heightFade * 0.5;
